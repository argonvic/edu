...
/**
 * Strings for component 'choicegroup', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   choicegroup
...
Usted puede llenar todas las que guste. Si deja algunas vacías, no se mostrarán. Si necesita más opciones, elija el botón "Agregar 3 campos al formato".';
...
$string['modulename_help'] = 'El módulo de selección de Grupo le permite a los estudiantes inscribirse ellos mismos en un grupo dentro de un curso. El profesor puede seleccionar los grupos en los cuales se inscribirán los alumnos y el número máximo de estudiantes permitidos en cada grupo.';
