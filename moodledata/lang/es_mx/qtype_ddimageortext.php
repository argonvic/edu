...
/**
 * Strings for component 'qtype_ddimageortext', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['addmoredropzones'] = 'Espacios vacíos para {no} zonas para soltar más';
$string['addmoreimages'] = 'Espacios vacíos para {no} items arrastrables más';
...
$string['formerror_noallowedtags'] = 'No están permitidas marcas HTML en este texto que es el texto alterno para una imagen arrastrable.';
...
$string['pleasedraganimagetoeachdropregion'] = 'Su respuesta no está completa; por favor, arrastre un ítem hacia cada zona de soltar.';
