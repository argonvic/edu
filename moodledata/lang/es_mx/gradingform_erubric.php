...
/**
 * Strings for component 'gradingform_erubric', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['lockzeropoints'] = 'Calcular calificación basada en que la rúbrica tenga un puntaje mínimo de 0, aunque no lo tenga';
...
$string['privacy:metadata:fillings:instanceid'] = 'La ID de la instancia de calificar de un intento de calificación de una persona que califica específica usando una e-rúbrica específica.';
$string['privacy:metadata:fillings:levelid'] = 'La ID del nivel seleccionado de un criterio de e-rúbrica.';
$string['privacy:metadata:fillings:remark'] = 'El texto del comentario proporcionado por una persona que califica durante le evaluación de un criterio de e-rúbrica.';
