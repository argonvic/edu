...
/**
 * Strings for component 'access', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   access
...
$string['breadcrumb'] = 'Camino de la ruta de navegación (rastro de migas de pan)';
$string['hideblocka'] = 'Ocultar {$a} bloque';
$string['monthnext'] = 'Siguiente mes';
