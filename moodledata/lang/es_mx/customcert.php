...
/**
 * Strings for component 'customcert', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   customcert
...
$string['deleteissueconfirm'] = '¿ Está seguro de querer este caso del certificado ?';
...
$string['privacy:metadata:customcert_issues:emailed'] = 'Si es que el ertificado fue enviado por Email o no';
