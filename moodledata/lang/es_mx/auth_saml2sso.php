...
/**
 * Strings for component 'auth_saml2sso', language 'es_mx', branch 'MOODLE_33_STABLE'
 *
...
$string['help_entityid'] = 'Nombre orígen del Provedor de Servicio disponible en /config/authsources.php';
