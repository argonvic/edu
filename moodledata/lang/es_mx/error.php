...
/**
 * Strings for component 'error', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   error
...
$string['agedigitalconsentmapinvaliddefault'] = 'El valor  (*) por defecto falta.';
$string['agelocationverificationdisabled'] = 'Verificación de ubicación y edad deshabilitada';
...
$string['mimetexisnotexist'] = 'Su sistema no está configurado para ejecutar mimeTeX. Usted necesita obtener el código fuente en C desde  <a href="http://www.forkosh.com/mimetex.zip">http://www.forkosh.com/mimetex.zip</a> compilarlo y colocar el ejecutable dentro de su directorio moodle/filter/tex/ .';
