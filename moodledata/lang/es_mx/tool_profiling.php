...
/**
 * Strings for component 'tool_profiling', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['pluginname'] = 'Corridas de perfilado (profiling)';
$string['privacy:metadata'] = 'El plugin de Perfilado no almacena ningún dato personal.';
$string['profilingfocusscript'] = 'Foco en corridas de perfilado (profiling) para el script: {$a}';
$string['profilingruns'] = 'Corridas de perfilado (profiling)';
...
$string['viewdetails'] = 'Ver detalles de perfilado (profiling)';
$string['viewdiff'] = 'Ver diferencias de perfilado (profiling) con:';
$string['viewdiffdetails'] = 'Ver detalles de diferencias de perfilado (profiling)';
