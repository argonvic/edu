...
/**
 * Strings for component 'block_autoattend', language 'es_mx', branch 'MOODLE_30_STABLE'
 *
...
$string['dbrepaired'] = 'La BasedeDatos fue reparada.';
...
Esta hora inexacta ocurre cuando el usuario es un admin. En ese caso, por favor configure correctamente una zona horaria de usuario de administración.<br />
Cuando una hora de usuario general (maestro) no corresponda, probablemente sea un error de programación \'bug\' . Por favor mande un reporte al creador del plugin.';
$string['Nstate'] = 'N';
...
$string['repairdbconfirm'] = '¿Ejecutar reparación de la BasedeDatos?';
...
$string['semiautoconfirm'] = 'Usted pued enviar una asistencia de la sesión de abajo . ¿ Enviar una asistencia ?';
...
$string['updatesessionattend'] = 'Actualizar Asistencia de Sesión';
