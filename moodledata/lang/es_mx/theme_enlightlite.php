...
/**
 * Strings for component 'theme_enlightlite', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['courselayoutdesc'] = 'Para cambiar el formato de visualización del listado de categoría de curso, elija uno de los listados personalizados aquí enlistados; esto anulará el diseño de course/index.php (por ejemplo coursecategory).
Ahora el archivo de diseño personalizado será usado en lugar del diseño por defecto de Moodle.';
...
$string['mspotmediadesc'] = 'Insertar una imagen o incrustar un video de YouTube.';
