...
/**
 * Strings for component 'report_insights', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['disabledmodel'] = 'Lo siento; este modelo ha sido deshabilitado por el administrador';
$string['indicator'] = 'Indicador';
$string['insight'] = 'Intuición (predicción)';
$string['insightprediction'] = 'predicción {$a}';
...
$string['nodetailsavailable'] = 'No hay detalles predictivos relevantes.';
...
$string['predictioncalculations'] = 'Cálculos del indicador';
$string['predictiondetails'] = 'Detalles de predicción';
$string['privacy:metadata'] = 'El plugin de Intuiciones (predicciones) no almacena ningún dato personal.';
$string['selectotherinsights'] = 'Seleccionar otras intuiciones (predicciones)...';
$string['timecreated'] = 'Tiempo predicho';
