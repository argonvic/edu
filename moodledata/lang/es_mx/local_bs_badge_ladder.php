...
/**
 * Strings for component 'local_bs_badge_ladder', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['courseladderinfo'] = 'Si se permite tabla de insignias del curso, puede ser (des)activada separadamente para cada curso.';
