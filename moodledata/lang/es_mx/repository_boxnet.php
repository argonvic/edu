...
/**
 * Strings for component 'repository_boxnet', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['information'] = 'Obtenga un secreto y una ID de cliente de<a href="https://app.box.com/developers/services">Box developer page</a> para su sitio Moodle.';
...
$string['privacy:metadata:repository_boxnet'] = 'El plugin del Repositorio Box no almacena ningún dato personal, pero si transmite datos desde Moodle hacia el sistema remoto.';
$string['privacy:metadata:repository_boxnet:query'] = 'La consulta de texto a buscar del usuario del Repositorio Box.';
