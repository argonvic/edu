...
$string['addon.mod_feedback.captchaofflinewarning'] = 'La retroalimentación con CAPTCHA no puede ser completada fuera-de-línea, o si no está configurada, o con el servidor caído.';
...
$string['addon.mod_quiz.confirmleavequizonerror'] = 'Ocurrió un error al guardar las respuestas. ¿Está Usted seguro de querer abandonar el examen?';
...
$string['addon.mod_quiz.errorquestionsnotsupported'] = 'Este examen no puede intentarse en la App porque contiene preguntas no soportadas por la App:';
...
$string['addon.mod_scorm.errornotdownloadable'] = 'La descarga de paquetes SCORM está deshabilitada. Por favor, contecte a su administrador del sitio.';
...
$string['addon.notes.warningnotenotsent'] = 'No se pudo añadir nota(s) al curso {{course}}. {{error}}';
...
$string['core.cannotconnect'] = 'No se puede conectar: Verifique que Usted escribió la URL correcta y que su sitio usa Moodle 2.4 o más reciente.';
$string['core.cannotdownloadfiles'] = 'La descarga de archivos está deshabilitada. Por favor contacte a su administrador del sitio.';
...
$string['core.clicktoseefull'] = 'Hacer click para ver los contenidos completos.';
...
$string['core.confirmloss'] = '¿Está Usted seguro? Se perderán todos los cambios.';
$string['core.confirmopeninbrowser'] = '¿Desea Usted abrirla en un navegador web?';
$string['core.contenteditingsynced'] = 'El contenido que Usted está editando ha sido sincronizado.';
...
$string['core.course.activitynotyetviewableremoteaddon'] = 'Su organización instaló un plugin complemento de terceros que todavía no está soportada por la App.';
...
$string['core.course.askadmintosupport'] = 'Contacte al administrador del sitio y dígale que Usted quiere usar esta actividad junto con la App Moodle Mobile.';
$string['core.course.confirmdeletemodulefiles'] = '¿Está Usted seguro de querer eliminar estos archivos?';
$string['core.course.confirmdownload'] = 'Usted está a punto de descargar {{size}}. ¿Está Usted seguro de querer continuar?';
$string['core.course.confirmdownloadunknownsize'] = 'No pudimos calcular el tamaño de la descarga. ¿Está Usted seguro de querer continuar?';
$string['core.course.confirmpartialdownloadsize'] = 'Usted está a punto de descargar <strong>al menos</strong> {{size}}. ¿Está Usted seguro de querer continuar?';
...
$string['core.courses.confirmselfenrol'] = '¿Está Usted seguro de querer inscribirse a Usted mismo en este curso?';
...
$string['core.courses.errorloadplugins'] = 'El plugin necesario para este curso no se pudo cargar correctamente. Por favor reinicie la App e inténtelo nuevamente.';
...
$string['core.errorinvalidresponse'] = 'Se recibió respuesta inválida. Por favor contacte a su administrador del sitio si el error persiste.';
...
$string['core.fileuploader.confirmuploadfile'] = 'Usted está a punto de subir {{size}}. ¿Está Usted seguro de querer continuar?';
$string['core.fileuploader.confirmuploadunknownsize'] = 'No se pudo calcular el tamaño de la subida. ¿Está Usted seguro de querer continuar?';
...
$string['core.login.checksiteversion'] = 'Revisar que su sitio usa Moodle 2.4 o más reciente.';
$string['core.login.confirmdeletesite'] = '¿Está Usted seguro de querer eliminar el sitio {{sitename}}?';
...
$string['core.login.legacymoodleversion'] = 'Usted está tratando de conectarse a una versión de Moodle no soportada. Por favor, descargue la App de Moodle Clásico para acceder a este sitio Moodle.';
$string['core.login.legacymoodleversiondesktop'] = 'Usted está intentando conectarse a <b>{{$a}}</b>.<br><br>Este sitio está ejecutando una versión antigua no soportada de Moodle, la cual no funcionará con esta App de Moodle Desktop.<br><br>Si este es su sitio, por favor póngase en contacto con su socio Moodle local para obtener asistencia para actualizarlo.<br><br>Vea <a href="https://moodle.com/contact">nuestra página de contacto</a> para enviar una solicitud para asistencia.';
$string['core.login.legacymoodleversiondesktopdownloadold'] = '<br><br>Alternativamente, Usted puede continuar accediendo a este sitio usando una versión no soportada de la App que puede descargarse desde aquí.';
...
$string['core.login.mobileservicesnotenabled'] = 'El acceso Mobile no está habilitado en su sitio. Por favor, contacte a su administrador del sitio si Usted piensa que se debería habilitar.';
$string['core.login.newsitedescription'] = 'Por favor escriba la URL de su sitio Moodle. Tenga en cuenta que podría no estar configurado para trabajar con esta App.';
$string['core.login.notloggedin'] = 'Usted necesita estar ingresado.';
$string['core.login.passwordrequired'] = 'Contraseña obligatoria';
$string['core.login.problemconnectingerror'] = 'Estamos teniendo dificultades para conectarnos';
$string['core.login.problemconnectingerrorcontinue'] = 'Revise dos veces que Usted haya ingresado la dirección correctamente e inténtelo nuevamente.';
...
$string['core.login.visitchangepassword'] = '¿Desea Usted visitar el sitio para cambiar la contraseña?';
$string['core.login.webservicesnotenabled'] = 'Los servicios web no están habilitados en su sitio. Por favor, póngase en contacto con su administrador del sitio si Usted piensa que se deberían habilitar.';
...
$string['core.mainmenu.appsettings'] = 'Configuraciones de la App';
...
$string['core.openfullimage'] = 'Hacer click aquí para mostrar la imagen a tamaño completo';
...
$string['core.question.errorattachmentsnotsupported'] = 'La aplicación todavía no soporta anexarle archivos a las respuestas.';
...
$string['core.settings.cordovadevicemodel'] = 'Modelo Dispositivo Cordova';
...
$string['core.settings.devicewebworkers'] = 'Device web workers (Trabajadores Web del Dispositivo) soportados';
...
$string['core.sharedfiles.nosharedfilestoupload'] = 'Usted no tiene archivos para subir aquí. Si Usted desea subir un archivo desde otra App, localice ese archivo y haga click en el botón para \'Abrir en\'.';
...
$string['core.windowsphone'] = 'Teléfono Windows';
