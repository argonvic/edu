...
/**
 * Strings for component 'my', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   my
...
$string['privacy:metadata:core_my:preference:user_home_page_preference'] = 'La preferencia de la página inicial del usuario configurada para la página del Tablero.';
