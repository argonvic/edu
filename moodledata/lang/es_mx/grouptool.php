...
/**
 * Strings for component 'grouptool', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   grouptool
...
$string['all_groups_full'] = '{$a} no pudo ser registrado en ningun grupo ¡ porque todos los grupos están llenos !';
...
$string['error_activating_group'] = 'Error al activar grupo {$a->groupid} en agrupamiento {$a->grouptoolid}!';
$string['error_at'] = 'Error en';
$string['error_deactivating_group'] = 'Error al desactivar grupo {$a->groupid} en herramientagrupo {$a->grouptoolid}!';
$string['error_getting_data'] = '¡Error al obtener datos del grupo! ¡Ya sea que ningun grupo o más de un grupo fueron regresados!';
$string['error_saving_new_order'] = 'Error al guardar nuevo orden para grupos: {$a}';
...
$string['groupsize_individual_gets_enabled'] = 'Si Usted continua, el tamaño de grupo individual será habilitado automáticamente. Impida este comportamiento al usar 0 como "{$a->field}" para no usar tamaño de grupo para nada, ¡o usar {$a->globalsize} para habilitar solamente tamaño de grupo global!';
...
$string['notification:group_recreated'] = 'El grupo "{$a->groupname}" ha sido recreado porque  grouptool <a href="{$a->grouptoolurl}" título="{$a->grouptoolname}">"{$a->grouptoolname}"</a> está configurado para recrear grupos eliminados.';
$string['notification:registrations_recreated'] = 'Los miembros del grupo "{$a->groupname}" han sido añadidos nuevamente debido a que el grouptool <a href="{$a->grouptoolurl}" título="{$a->grouptoolname}">"{$a->grouptoolname}"</a> está configurado para recrear grupos eliminados. El grupo mismo fue recreado por otra instancia de grouptool.';
...
$string['swapped_groups'] = '¡ Grupos intercambiados {$a->a} (order {$a->aorder}) y {$a->b} (order {$a->border})!';
...
$string['user_moved'] = '¡{$a->userid} ha sido movido de la cola del grupo "{$a->from_group}" al grupo "{$a->to_group}"!';
$string['user_move_prev'] = '¡"{$a->user}" será movido de la cola del grupo "{$a->from_group}" al fruo "{$a->to_group}"!';
