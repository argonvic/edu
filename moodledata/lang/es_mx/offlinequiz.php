...
/**
 * Strings for component 'offlinequiz', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   offlinequiz
...
$string['marginwarning'] = '¡ Por favor, imprima los siguientes archivos PDF sin márgenes adicionales !<br /> Evite el entregarle fotocopias a los estudiantes. Si Usted tiene dudas, ordene más impresiones al equipo de soporte.';
...
$string['partcheckedwithoutresult'] = '<a href="{$a->url}">{$a->count} participantes revisados sin resultados</a>';
$string['partcheckedwithresult'] = '{$a} participantes revisados con resultados';
...
$string['partuncheckedwithoutresult'] = '{$a} participantes no-revisados sin  resultados';
$string['partuncheckedwithresult'] = '<a href="{$a->url}">{$a->count} participantes no-revisados con  resultados</a>';
...
$string['privacy:metadata:core_files'] = 'Offlinequiz usa la API de archivo para almacenar la pregunta generada y las hojas de respuestas y las hojas de respuestas rellenadas.';
...
$string['privacy:metadata:offlinequiz'] = 'La tabla offlinequiz guarda toda la información específica a una instancia de offlinequiz';
...
$string['privacy:metadata:offlinequiz_choices:scannedpageid'] = 'la página escaneada a la cual se refiere la opción';
$string['privacy:metadata:offlinequiz_choices:slotnumber'] = 'La posición de pregunta de esta opción';
$string['privacy:metadata:offlinequiz_choices:value'] = 'Si es que la opción se considera tachada. 0 para no. 1 para si, -1 para incierto.';
...
$string['privacy:metadata:offlinequiz:disableimgnewlines'] = 'Si deberían deshabilitarse las nuevas líneas antes y después de  las imágenes';
...
$string['privacy:metadata:offlinequiz:fileformat'] = 'El formato_del_archivo que es usado para imprimir las hojas de preguntas, 0 para PDF, 1 para DOCX, 2 para LaTex';
$string['privacy:metadata:offlinequiz:fontsize'] = 'El tamaño del tipo de letra (font) en las hojas de preguntas.';
$string['privacy:metadata:offlinequiz:grade'] = 'La calificación muestra la cantidad máxima de puntos a obtener en esta prueba.';
$string['privacy:metadata:offlinequiz_group_questions'] = 'Esta Tabla guarda todas las preguntas para cada grupo de offlinequiz.';
$string['privacy:metadata:offlinequiz_group_questions:maxmark'] = 'La cantidad máxima de puntos que se pueden obtener para esta pregunta';
$string['privacy:metadata:offlinequiz_group_questions:offlinegroupid'] = 'El grupo offlinequiz al cual se relaciona esta pregunta de grupo';
$string['privacy:metadata:offlinequiz_group_questions:offlinequizid'] = 'La id del offlinequiz con el que se relaciona esta pregunta de grupo';
...
$string['privacy:metadata:offlinequiz_group_questions:position'] = 'La posición de este offlinequiz';
...
$string['privacy:metadata:offlinequiz_groups'] = 'Tabla para los grupos en los que las pruebas toman parte.';
$string['privacy:metadata:offlinequiz_groups:answerfilename'] = 'El nombre_del_archivo que fue usado para guardar el archivo_de_respuestas';
$string['privacy:metadata:offlinequiz_groups:correctionfilename'] = 'El archivo que fue usado para guardar el archivo de corrección';
...
$string['privacy:metadata:offlinequiz_groups:numberofpages'] = 'la cantidad de páginas que se necesitan para imprimir las hojas de respuestas';
$string['privacy:metadata:offlinequiz_groups:offlinequizid'] = 'La id del offlinequiz al cual pertenece este offlinequiz.';
$string['privacy:metadata:offlinequiz_groups:questionfilename'] = 'El nombre_de_archivo que fue usado para guardar el archivo_de_preguntas';
...
$string['privacy:metadata:offlinequiz_groups:templateusageid'] = 'La id del uso_de_plantilla, que es usada para crear un resultado en la API de examen';
...
$string['privacy:metadata:offlinequiz_hotspots:blank'] = 'Si el hotspot es analizado exitosamente';
$string['privacy:metadata:offlinequiz_hotspots:name'] = 'Tipo del hotspot, ya sea u%number para hotspot de usuario, a-0-0 para pregunta 1 respuesta 1, y así sucesivamente';
$string['privacy:metadata:offlinequiz_hotspots:scannedpageid'] = 'Página escaneada en donde está el hotspot.';
$string['privacy:metadata:offlinequiz_hotspots:time'] = 'la última hora de actualización para este hotspot';
$string['privacy:metadata:offlinequiz_hotspots:x'] = 'El valor x del hotspot';
$string['privacy:metadata:offlinequiz_hotspots:y'] = 'El valor y del hotspot';
$string['privacy:metadata:offlinequiz:id_digits'] = 'Guarda la cantidad de dígitos que tenía el idnumber (número_id) cuando las hojas de respuesta fueron creadas. Esto es necesario para compatibilidad retrograda si la cantidad es elevada entre la creación y laimportación de las hojas de respuestas.';
...
$string['privacy:metadata:offlinequiz:numgroups'] = 'La cantidad de grupos diferentes que tiene este offlinequiz.';
$string['privacy:metadata:offlinequiz_page_corners'] = 'Esta tabla guarda todas las esquinas para todas las páginas escaneadas para evaluar más rápidamente para la siguiente evaluación o corrección';
$string['privacy:metadata:offlinequiz_page_corners:position'] = 'La información acerca de si esta esquina está o no en la parte superior o inferior y derecha o izquierda.';
$string['privacy:metadata:offlinequiz_page_corners:scannedpageid'] = 'La página-escaneada en donde está esta esquina';
...
$string['privacy:metadata:offlinequiz:papergray'] = 'La escala_de_grises de este offlinequiz';
$string['privacy:metadata:offlinequiz_participants'] = 'la tabla de participantes guarda si es que el usuario estaba tomando parte en la prueba o no.';
...
$string['privacy:metadata:offlinequiz_participants:listid'] = 'La id de la lista en donde está este participante';
$string['privacy:metadata:offlinequiz_participants:userid'] = 'El userid (id_del_usuario) del usuario';
$string['privacy:metadata:offlinequiz_p_choices'] = 'Esta tabla guarda todas las cruces para las listas de participantes';
$string['privacy:metadata:offlinequiz_p_choices:scannedpageid'] = 'La página-escaneada con la cual se relaciona esta opción';
$string['privacy:metadata:offlinequiz_p_choices:userid'] = 'El userid (id_del_usuario) del que se ocupa esta opción';
$string['privacy:metadata:offlinequiz_p_choices:value'] = 'Si la cruz está rellenada o no (0 para no llenada, 1 para llenada, -1 para incierto)';
$string['privacy:metadata:offlinequiz:pdfintro'] = 'El texto introductorio que es insertado en las hojas de respuesta en el principio.';
$string['privacy:metadata:offlinequiz_p_lists'] = 'esta tabla guarda información acerca de listas de participantes, en donde los profesores pueden anotar si el estudiante estaba allí o no';
...
$string['privacy:metadata:offlinequiz:printstudycodefield'] = 'Una preferencia respecto a si el código de estudio debería de ser impreso en los campos de pregunta. 1 para cierto, 0 en caso contrario.';
$string['privacy:metadata:offlinequiz_queue'] = 'Esta tabla guarda una cola de espera de una subida. Para cada subida hay un objeto propio en esta tabla';
...
$string['privacy:metadata:offlinequiz_queue_data:error'] = 'Si el estado es de error, aquí estará un mensaje más detallado del error';
$string['privacy:metadata:offlinequiz_queue_data:filename'] = 'el nombre_de_archivo del archivo de este objeto de datos en cola de espera';
$string['privacy:metadata:offlinequiz_queue_data:queueid'] = 'la cola de espera a la que pertenecen estos datos';
$string['privacy:metadata:offlinequiz_queue_data:status'] = 'El estado de los datos en la cola de espera';
$string['privacy:metadata:offlinequiz_queue:importuserid'] = 'El userid (id_del-usuario) del profesor que importó los archivos';
$string['privacy:metadata:offlinequiz_queue:offlinequizid'] = 'La id del offlinequiz de la cola de espera';
$string['privacy:metadata:offlinequiz_queue:status'] = 'el estado de la cola de espera que es necesitada';
$string['privacy:metadata:offlinequiz_queue:timecreated'] = 'La hora en la que estas hojas de offlinequiz fueron importadas';
$string['privacy:metadata:offlinequiz_queue:timefinish'] = 'La hora en la que la evaluación de la cola de espera fue terminada';
$string['privacy:metadata:offlinequiz_queue:timestart'] = 'La hora en la que la evaluación de la cola de espera fue iniciada';
$string['privacy:metadata:offlinequiz_results'] = 'Esta tabla guarda todos los datos de resultados, los que no son almacenables en la API del examen';
...
$string['privacy:metadata:offlinequiz_results:timefinish'] = 'La hora de terminación en la que el resultado fue insertado por  primera vez';
$string['privacy:metadata:offlinequiz_results:timemodified'] = 'La fecha de modificación para el resultado';
$string['privacy:metadata:offlinequiz_results:timestart'] = 'El principio de la hora en la que el resultado fue insertado la primera vez';
$string['privacy:metadata:offlinequiz_results:usageid'] = 'La id del uso de plantilla del API de examen en donde es guadado este resultado';
$string['privacy:metadata:offlinequiz_results:userid'] = 'El usuario a quien pertenecece este resultado';
$string['privacy:metadata:offlinequiz:review'] = '';
$string['privacy:metadata:offlinequiz_scanned_pages'] = 'Esta tabla guarda información acerca de una página escaneada de una prueba fuera-de-línea';
$string['privacy:metadata:offlinequiz_scanned_pages:error'] = 'El error detallado que tiene esta página (si existe).';
$string['privacy:metadata:offlinequiz_scanned_pages:filename'] = 'El nombre_de_archivo de la página escaneada';
$string['privacy:metadata:offlinequiz_scanned_pages:groupnumber'] = 'El nombre_de_grupo del grupo al cual pertenece este offlinequiz';
$string['privacy:metadata:offlinequiz_scanned_pages:offlinequizid'] = 'el offlinequiz de la página escaneada';
$string['privacy:metadata:offlinequiz_scanned_pages:pagenumber'] = 'El número_de_página de esta página';
...
$string['privacy:metadata:offlinequiz_scanned_pages:time'] = 'La hora en la que fue procesada la página';
$string['privacy:metadata:offlinequiz_scanned_pages:userkey'] = 'El userkey (clave_del_usuario), que no es userid (id_del_usuario) del usuario tachado en esta página';
$string['privacy:metadata:offlinequiz_scanned_pages:warningfilename'] = 'El nombre_del_archivo del archivo que es creado cuando una prueba mal llenada es corregida y el usuario obtiene una advertencia al respecto';
$string['privacy:metadata:offlinequiz_scanned_p_pages'] = 'Esta tabla guarda páginas de participante y sus informaciones generales';
$string['privacy:metadata:offlinequiz_scanned_p_pages:error'] = 'el error (si existiera) que esta página disparó al ser procesada';
...
$string['privacy:metadata:offlinequiz_scanned_p_pages:offlinequizid'] = 'El offlinequiz  al cual pertenece esta página de participantes';
$string['privacy:metadata:offlinequiz_scanned_p_pages:status'] = 'el estado de esta página escaneada';
$string['privacy:metadata:offlinequiz_scanned_p_pages:time'] = 'La hora en la que esta página fue procesada';
...
$string['privacy:metadata:offlinequiz:showquestioninfo'] = 'Guarda si es que la información acerca de las preguntas debería de ser mostrada, 0 para no, 1 para información acerca del tipo de pregunta, 2 para pregunta acerca de la cantidad de respuestas correctas.';
$string['privacy:metadata:offlinequiz:showtutorial'] = 'Guarda si es que a los estudiantes debería de pedírseles que hagan un tutorial del offlinequiz.';
$string['privacy:metadata:offlinequiz:shufflequestions'] = 'Una preferencia acerca de si las preguntas deberían de barajarse al crear un examen. 1 para barajarlas, 0 en caso contrario.';
...
$string['privacy:metadata:offlinequiz:timecreated'] = 'La hora en la que fue creado el offlinequiz';
$string['privacy:metadata:offlinequiz:timemodified'] = 'La columna time (hora) guarda la hora en la que el offlinequiz fue cambiado por última vez.';
...
\\makeatletter %%% deshabilitar saltos de página entre respuestas
\\@beginparpenalty=10000
\\@itempenalty=10000
\\makeatother
%
\\newcommand{\\answerIs}[1]{} %%%Deshabilitar mostrar la respuesta correcta
% \\newcommand{\\answerIs}[1]{[#1]} %%%Habilitar mostrar la respuesta correcta
%%%
...
\\InputIfFileExists{offline_test_extras.tex}{}{} % Ingresar definiciones extra del usuario
