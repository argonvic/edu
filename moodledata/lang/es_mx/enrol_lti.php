...
/**
 * Strings for component 'enrol_lti', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   enrol_lti
...
$string['privacy:metadata:enrol_lti_users'] = 'La lista de usuarios inscritos vía un provedor LTI.';
