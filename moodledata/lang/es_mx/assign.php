...
/**
 * Strings for component 'assign', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   assign
...
$string['addsubmission_help'] = 'Usted aun no ha hecho un envío';
...
$string['attemptreopenmethod_help'] = 'Determina cómo se reabren los envíos de los estudiantes. Las opciones disponibles son: <ul><li>Nunca- El envío del estudiante no puede ser reabierto. </li><li>Manualmente -  El envío del estudiante puede ser reabierto por un profesor.
...
$string['clickexpandreviewpanel'] = 'Haga clic para expander el panel de revisión';
...
$string['cutoffdatefromdatevalidation'] = 'La fecha de corte no debe ser anterior a la fecha de \'permitir envíos\'.';
...
$string['duedatevalidation'] = 'La fecha de entrega no puede ser anterior a la fecha de permitir entregas a partir de.';
...
$string['fixrescalednullgradesconfirm'] = '¿ Está Uste seguro de querer corregir calificaciones erróneas ? Todas las calificaciones afectadas serán eliminadas. Esto podría afectar los totales del curso.';
...
$string['gradingduefromdatevalidation'] = 'La fecha para recordarme calificar  no puede ser antes de la fecha para permitir envíos.';
...
$string['privacy:metadata:assignmarkerfilter'] = 'Filtrar el resumen de tarea  por la persona que califica asignada.';
...
$string['privacy:metadata:grader'] = 'La ID del usuario de la persona que califica.';
