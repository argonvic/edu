...
/**
 * Strings for component 'reengagement', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['emailrecipient_help'] = 'Cuando necesita enviarse una notificación para motivar a un usuario a re-comprometerse con el curso, esta configuración controla si se envía una notificación al usuario, a su mánager o a ambos.';
...
$string['emailsubjectmanager'] = 'Asunto de la notificación (Mánager)';
