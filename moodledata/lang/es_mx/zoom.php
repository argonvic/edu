...
/**
 * Strings for component 'zoom', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   zoom
...
$string['googlecalendar'] = 'Calendario Google';
$string['googleiconalt'] = 'Ícono de Google';
...
$string['privacy:metadata:mdl_zoom_meeting_details'] = 'La tabla de la base de datos que almacena información acerca de  cada instancioa de reunión.';
$string['privacy:metadata:mdl_zoom_meeting_details:topic'] = 'El nombre de la reunión a la que asistió el usuario.';
$string['privacy:metadata:mdl_zoom_meeting_participants'] = 'La tabla de la base de datos que almacena información acerca de participantes en reuniones.';
$string['privacy:metadata:mdl_zoom_meeting_participants:attentiveness_score'] = 'El puntaje de atención del participante';
$string['privacy:metadata:mdl_zoom_meeting_participants:duration'] = 'Por cuanto tiempo estuvo en la reunión el participante';
$string['privacy:metadata:mdl_zoom_meeting_participants:join_time'] = 'El momento en el que el participante se unió a la reunión';
$string['privacy:metadata:mdl_zoom_meeting_participants:leave_time'] = 'El momento en el que el participante dejó la reunión';
$string['privacy:metadata:mdl_zoom_meeting_participants:name'] = 'El nombre del participante';
$string['privacy:metadata:mdl_zoom_meeting_participants:user_email'] = 'El Email del participante';
...
$string['windowsiconalt'] = 'Ícono de Windows';
