...
/**
 * Strings for component 'analytics', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   analytics
...
$string['errornotarget'] = 'Este modelo todavía no tiene ningún destino.';
...
$string['predictionsprocessor_help'] = 'Los procesadores de predicción son los \'backends\' de aprendizaje de máquina que procesan los conjuntos_de_datos generados por indicadores y objetivos de modelos de cálculo. Todas las predicciones y algoritmos entrenados serán eliminados si Usted cambia hacia otro procesador de predicciones.';
