...
/**
 * Strings for component 'mootyper', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   mootyper
...
$string['fmode'] = 'Modo';
$string['fmode_help'] = 'El modo de lección presentará cada ejercicio en una Lección/Categoría hasta que todos sean completados. El modo examen mostrará solamente el ejercicio seleccionado para el examen. Una vez que Usted haga clic en Guardar y mostrar, Usted no podrá cambiar el modo.';
...
$string['privacy:metadata:mootyper_lessons:lessonname'] = 'El nombre de la lección o categoría.';
