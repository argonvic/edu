...
/**
 * Strings for component 'assignfeedback_poodll', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['downloadsok'] = 'Mostrar enlace para descargar';
$string['downloadsok_details'] = '';
$string['enabled'] = 'Retroalimentación para PoodLL';
$string['enabled_help'] = 'Si se habilita, el profesor que califica puede dejar retroalimentación en audio/video para cada envío.';
$string['no'] = 'no';
...
$string['replyvideo'] = 'Video Grabadora';
