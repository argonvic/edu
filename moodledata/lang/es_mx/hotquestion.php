...
/**
 * Strings for component 'hotquestion', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   hotquestion
...
$string['allowanonymouspost_help'] = 'Si se habilita, las preguntas pueden ser publicadas anónimamente, y si se aprubean para ver, los votos de popularidad pueden ser hechos por todos.';
...
$string['exportfilenamep2'] = '_HQ_Preguntas_adas_En_';
$string['heat'] = 'Calor';
...
$string['modulename_help'] = 'Una actividad de Pregunta Caliente les permite a los estudiates publicar/votar preguntas, en respuesta a solicitudes hechas por sus profesores del curso.';
$string['modulenameplural'] = 'Preguntas Calientes';
$string['newround'] = 'Abrir una nueva ronda';
$string['newroundconfirm'] = '¿Está seguro? (las preguntas y votos existentes serán archivadas)';
...
$string['postbutton'] = 'Click para publicar';
...
$string['requireapproval_descr'] = 'Si se habilita, las preguntas requieren aprobación por un profesor antes de sean visibles por todos.';
$string['requireapproval_help'] = 'Si se habilita, las preguntas requieren aprobación por un profesor antes de que sean visibles por todos.';
