...
/**
 * Strings for component 'plagiarism_turnitin', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['assigngeterror'] = 'No se pudieron obtener datos de turnitintooltwo';
...
$string['checkagainstnote'] = 'Nota: Si Usted no selecciona "Si" para al menos una de las opciones inferiores para "Revisar contra ..." entonces NO se generará un Reporte de Originalidad.';
...
$string['errorcode1'] = 'Este archivo no ha sido enviado a Turnitin porque no tiene suficiente contenido para producir un Reporte de Originalidad.';
...
$string['pp_configuredesc'] = 'Usted debe configurar este módulo dentro del módulo  turnitintooltwo. Por favor haga clic <a href={$a}/admin/settings.php?section=modsettingturnitintooltwo>aquí</a> para configurar este plugin';
...
$string['privacy:metadata:plagiarism_turnitin_files:orcapable'] = 'Indica si es que Turnitin pudo o no producir un reporte de originalidad para el envío del usuario.';
...
$string['studentreports_help'] = 'Le permite mostrar reportes de originalidad Turnitin a usuarios estudiantes. Si se configura a Si, los reportes de originalidad generado p por Turnitin están disponibles para que los estudiantes los vean.';
...
$string['turnitin:viewfullreport'] = 'Permitirle al profesor ver el reporte completo regresado por Turnitin';
