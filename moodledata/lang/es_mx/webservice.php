...
/**
 * Strings for component 'webservice', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   webservice
...
$string['eventwebserviceservicecreated'] = 'Servicio de servicio web creado';
$string['eventwebserviceservicedeleted'] = 'Servicio de servicio web eliminado';
$string['eventwebserviceserviceupdated'] = 'Servicio de servicio web actualizado';
$string['eventwebserviceserviceuseradded'] = 'Usuario de servicio de servicio web añadido';
$string['eventwebserviceserviceuserremoved'] = 'Usuario de servicio de servicio web removido';
...
$string['privacy:metadata:serviceusers:validuntil'] = 'La fecha en la cual termina la autorización';
...
$string['servicerequireslogin'] = 'Servicio web no está disponible (se ha salido de la sesión o ha expirado)';
