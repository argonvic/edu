...
/**
 * Strings for component 'geogebra', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   geogebra
...
$string['geogebraurl_help'] = 'Este parámetro habilita una URL para especificar la actividad GeoGebra, en lugar de seleccionarlo a través del selector de archivos.';
...
$string['modulename_help'] = '<b>ATENCIÓN!!</b> <br>Versión alfa del módulo de GeoGebra para Moodle 2. Está incompleta y, por lo tanto, algunas partes pueden no funcionar adecuadamente.';
