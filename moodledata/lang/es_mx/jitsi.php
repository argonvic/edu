...
/**
 * Strings for component 'jitsi', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   jitsi
...
$string['jitsifieldset'] = 'Conjunto_de_campo de ejemplo personalizado';
$string['jitsiname'] = 'Nombre de sesión';
$string['jitsiname_help'] = 'Este es el contexto de la herramientita de ayuda asociada con el campo Jitsi. La sintaxis Markdown está soportada.';
$string['jitsi:submit'] = 'Enviar Jitsi';
$string['jitsi:view'] = 'Ver Jitsi';
$string['modulename'] = 'Jitsi';
$string['modulename_help'] = 'Usar el módulo Jitsi para videoconferencia';
$string['modulenameplural'] = 'Jitsi';
$string['nostart'] = 'La sesión no ha iniciado. Usted puede acceder 30 minutos antes del inicio.';
