...
/**
 * Strings for component 'rating', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   rating
...
$string['rolewarning_help'] = 'Para enviar valuaciones (ratings), los usuarios necesitan la capacidad \'moodle/rating:rate\' y cualquier capacidad específica del módulo. Los usuarios asignados a los roles siguientes deberían poder valuar items. La lista de roles puede ser modificada a través del enlace a permisos en el bloque de Administración.';
