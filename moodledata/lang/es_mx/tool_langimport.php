...
/**
 * Strings for component 'tool_langimport', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['langpacknotremoved'] = 'Ha ocurrido un error; el paquete del idioma \'{$a}\' no está completamente des-instalado, por favor revise los permisos de archivos.';
$string['langpackremoved'] = 'El paquete de idioma  \'{$a}\'  fue desinstalado';
$string['langpackremovedevent'] = 'Paquete de idioma desinstalado';
$string['langpackupdated'] = 'El paquete de idioma \'{$a}\' fue actualizado exitosamente';
