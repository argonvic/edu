...
/**
 * Strings for component 'qtype_coderunner', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['badjsonorfraction'] = 'JSON malo, o falta fracción en la salida del calificador combinador. La salida fue: {$a->output}';
...
$string['bulkquestiontester'] = 'El <a href="{$a->link}">script para pruebas masivas</a> prueba que las respuestas de muestra para todas las preguntas en el contexto actual sean calificadas correctamente';
...
La configuración del campo \'resultcolumns\' o no tiene efecto si una plantilla calificadora combinadora está siendo usada. El atributo \'resulttablecolumnformats\' delvalor de retorno del calificador de plantilla combinatoria deberpia de usarse en su lugar.';
...
$string['table_ui_missingparams'] = 'La Interfaz del Usuario de la tabla necesita los parámetros de la plantilla table_num_columns, table_num_rows y table_column_headers.';
