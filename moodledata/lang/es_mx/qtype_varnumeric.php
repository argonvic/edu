...
/**
 * Strings for component 'qtype_varnumeric', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['privacy:metadata'] = 'El plugin de variable numérica no almacena ningún dato personal.';
