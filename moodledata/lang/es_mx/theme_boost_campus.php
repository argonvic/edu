...
/**
 * Strings for component 'theme_boost_campus', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['imageareaitemssetting_desc'] = 'Con este chunche Usted puede subir sus imágenes que serán mostradas en la región del área de imágenes adicionales. Las imágenes serán ordenadas y mostradas alfabéticamente segun el nombre del archivo. Para quitar esta región, simplemente elimine todas las imágenes subidas.';
