...
/**
 * Strings for component 'enrol_lmb', language 'es_mx', branch 'MOODLE_34_STABLE'
 *
 * @package   enrol_lmb
...
$string['lmbusernamehelp'] = 'Esta es la contraseña usada para limitar el acceso a la interfaz de LMB. Debe de coincidir con las configuraciones en Luminis Message Broker.';
$string['locality'] = 'XML del usuario \'localidad\\';
...
<ul>
<li>Dirección Email completa: La direcciòn completa de Email es usada como nombre_de_usuario .
