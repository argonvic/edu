...
/**
 * Strings for component 'quiz', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   quiz
...
$string['canredoquestions_desc'] = 'Si se habilita, entonces cuando los estudiantes hayan terminado una pregunta en particular, ellos verán un botón para \'Re-hacer la pregunta\'. Esto les permite intentar otra versión de la misma pregunta, sin tener enviar el examen completo e iniciar otro examen nuevo. Esta opción es principalmente útil para exámenes de práctica.

Esta configuración solamente afecta a las preguntas (por ejemplo, preguntas que no sean del tipo de Ensayo) y a los comportamientos (por ejemplo, retroalimentación inmediata, o interactiva con intentos múltiples), en donde es posible que el estudiante termine la pregunta antes de que el intento sea enviado.';
$string['canredoquestions_help'] = 'Si se habilita, entonces cuando los estudiantes hayan terminado una pregunta en particular, ellos verán un botón para \'Re-hacer la pregunta\'. Esto les permite intentar otra versión de la misma pregunta, sin tener enviar el examen completo e iniciar otro examen nuevo. Esta opción es principalmente útil para exámenes de práctica.

Esta configuración solamente afecta a las preguntas (por ejemplo, preguntas que no sean del tipo de Ensayo) y a los comportamientos (por ejemplo, retroalimentación inmediata, o interactiva con intentos múltiples), en donde es posible que el estudiante termine la pregunta antes de que el intento sea enviado.';
$string['canredoquestionsyes'] = 'Los estudiantes pueden re-hacer otra versión de cualquier pregunta terminada';
...
$string['graceperiod_help'] = 'Si se configura que cuando se agote el tiempo a "Hay un período de gracia para enviar el intento, pero no pueden cambiarse las respuestass", esta es la cantidad de tiempo extra que se permite.';
...
$string['messageprovider:submission'] = 'Notificación de envíos del examen';
$string['min'] = 'Mín';
...
$string['quiz:emailconfirmsubmission'] = 'Recibir un mensaje de confirmación al enviar';
$string['quiz:emailnotifysubmission'] = 'Recibir un mensaje de notificación cuando un intento es enviado';
$string['quiz:emailwarnoverdue'] = 'Recibir un mensaje de notificación cuando un intento está vencido y necesita ser enviado.';
...
**Inmediatamente después del intento** estas configuraciones aplican para los primeros dos minutos después de hacer clic en \'Enviar todo y terminar\'.
...
$string['shufflequestions_help'] = 'Si Usted activa esto, cada vez que se intente contestar el examen, se barajará el orden de las preguntas en esta sección a un nuevo orden aleatorio.

Esto puede dificultar el que los estudiantes se compartan las respuestas, pero también hace más difícil que los estudiantes discutan con Usted alguna pregunta en particular.';
