...
/**
 * Strings for component 'gradingform_btec', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['privacy:metadata:preference:showmarkerdesc'] = 'Si es que se muestran o no descripciones de criterio de persona que califica';
