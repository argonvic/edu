...
/**
 * Strings for component 'local_bulkenrol', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['bulkenrol_form_intro'] = 'Aquí, Usted puede inscribir masivamente usuarios a su curso. Un usuario a ser inscrito es identificado por su dirección E-mail almacenada en su cuenta Moodle.';
...
$string['error_getting_user_for_email'] = 'Hubo un problema al obtener el registro de usuario para la dirección E-mail adress <em>{$a}</em> de la base de datos';
...
$string['error_more_than_one_record_for_email'] = 'Se encontró más de una cuenta de usuario Moodle existente con la dirección de E-mail <em>{$a}</em>em>.<br /> Esta línea será ignorada y ninguno de los usuarios Moodle existentes será inscrito.';
$string['error_no_email'] = 'No se encontró dirección E-mail en la línea {$a->line} (<em>{$a->content}</em>). Esta línea será ignorada.';
...
$string['user_groups_already'] = 'El usuario ya era miembro';
$string['user_groups_yes'] = 'Usuario añadido al grupo';
