...
/**
 * Strings for component 'tool_dataprivacy', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['showdataretentionsummary_desc'] = 'Si se habilita, un enlace hacia el resumen de retención de datos es mostrado en el pie de la página y en la página del perfil del usuario.';
