...
/**
 * Strings for component 'tool_mobile', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   tool_mobile
...
$string['custommenuitems_desc'] = 'Se pueden añadir ítems adcionales al menú principal de la App al especificarlos aquí. Ingrese cada ítem de menú personalizado en una línea nueva con el formato: texto del ítem, URL del enlace, método de apertura del enlace y código de idioma (opcional, para mostrarle el ítem solamente a usuarios del idioma especificado), separados por caracteres de barra vertical | .
...
$string['setuplink_desc'] = 'URL de página que enlaza a la descarga de la App Mobile desde la App Store y Google Play.';
