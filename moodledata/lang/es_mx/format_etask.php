...
/**
 * Strings for component 'format_etask', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['progresscharts'] = 'gráficas de progreso eTask';
$string['progresscharts_calculate'] = 'Calcular gráficas de progreso Completado y Pasado';
$string['progresscharts_donotcalculate'] = 'No calcular gráficas de progreso Completado y Pasado';
$string['progresscharts_help'] = 'Esta configuración determina si es que las gráficas de progreso Completado y Pasado son calculadas o no en la ventanita emergente de la actividad de tabla de calificación eTask .';
