...
/**
 * Strings for component 'lesson', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   lesson
...
$string['inactiveoverridehelp'] = '* El estudiante no tiene el grupo o el rol correcto para ver/intentar la lección';
