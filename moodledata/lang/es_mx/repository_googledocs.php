...
/**
 * Strings for component 'repository_googledocs', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['fileoptions'] = 'Los tipos y configuraciones por defecto  para archivos regresados es configurable aquí. Por favor tenga en cuenta que todos los archivos ligados externamente serán actualizados de forma tal que el propietario sea la cuenta del sistema de Moodle.';
...
$string['internal'] = 'Internos (archivos guardados en Moodle)';
