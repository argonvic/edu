...
/**
 * Strings for component 'forum', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   forum
...
$string['discussionpin'] = 'Apuntalar';
$string['discussionpinned'] = 'Apuntalada';
$string['discussionpinned_help'] = 'Las discusiones apuntaladas aparecerán en la parte superior de un foro.';
...
$string['discussionunpin'] = 'Des-apuntalar';
...
$string['eventdiscussionpinned'] = 'Discusión apuntalada';
...
$string['eventdiscussionunpinned'] = 'Discusión des-apuntalada';
...
$string['forum:addnews'] = 'Añadirr anuncios';
...
$string['forum:canposttomygroups'] = 'Usted puede publicar en todos los grupos a los que tiene acceso';
...
$string['forum:pindiscussions'] = 'Apuntalar discusiones';
...
$string['postbymailsuccess'] = 'Felicitaciones, su publicación de foro con asunto "{$a->subject}" fue exitosamente añadida. Usted puede verla en {$a->discussionurl}.';
$string['postbymailsuccess_html'] = 'Felicitaciones, su <a href="{$a->discussionurl}">publicación en foro</a>  con asunto  "{$a->subject}" fue publicada exitosamente.';
...
Si se configura a pcional, los participantes pueden elegir activar o desactivar el seguimiento mediante un enlace en el bloque de administración (Los usuarios deben de tener también habilitado el seguimiento del foro en sus preferencias del foro).
