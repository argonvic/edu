...
/**
 * Strings for component 'chat', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   chat
...
$string['messageyoubeep'] = 'Usted hizo señal de sonido bip {$a}';
