...
$string['agreednowithlink'] = 'Consentimiento no  otorgado; hacer clic para otorgar consentimiento a nombre y en representación del usuario para  {$a}';
$string['agreednowithlinkall'] = 'Consentimiento no  otorgado; hacer clic para otorgar consentimiento a nombre y en representación del usuario para todas las políticas';
...
$string['agreedyesonbehalfwithlink'] = 'Consentimiento otorgado a nombre de y en representación del usuario; hacer clic para retirar consentimiento del usuario para "{$a}"';
$string['agreedyesonbehalfwithlinkall'] = 'Consentimiento otorgado a nombre de y en representación del usuario; hacer clic para retirar consentimiento del usuario para todas las políticas';
$string['agreedyeswithlink'] = 'Consentimiento otorgado; hacer clic para retirar consentimiento para "{$a}"';
$string['agreedyeswithlinkall'] = 'Consentimiento otorgado; hacer clic para retirar consentimiento para todas las políticas';
...
$string['consentdetails'] = 'Otorgar consentimiento a nombre y en representación de usuario(s)';
$string['consentpagetitle'] = 'Consentir';
$string['contactdpo'] = 'Para preguntas acerca de las políticas, por favor contacte al Oficial de Privacidad.';
...
$string['privacy:metadata:acceptances:lang'] = 'El idioma usado para mostrar la política cuando fue se otorgó el consentimiento.';
...
$string['privacy:metadata:acceptances:policyversionid'] = 'La  versión de la política para la cual se otorgó consentimiento.';
...
$string['privacy:metadata:versions:audience'] = 'El tipo de usuarios a quienes se les pide otorgar su consentimiento.';
...
$string['privacy:metadata:versions:type'] = 'El tipo de política.';
