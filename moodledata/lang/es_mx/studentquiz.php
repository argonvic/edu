...
/**
 * Strings for component 'studentquiz', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   studentquiz
...
Su pregunta \'{$a->questionname}\' en el curso \'{$a->coursename}\' en actividad StudentQuiz \'{$a->modulename}\' ha sido aprobada por \'{$a->actorname}\'
en \'{$a->timestamp}\'.
...
Su pregunta \'{$a->questionname}\' en el curso \'{$a->coursename}\' en actividad StudentQuiz \'{$a->modulename}\' ha sido modificada por \'{$a->actorname}\'
en \'{$a->timestamp}\'.
...
La aprobación de su pregunta \'{$a->questionname}\' en la actividad StudentQuiz \'{$a->modulename}\' en curso \'{$a->coursename}\' ha sido revocada por  \'{$a->actorname}\' en \'{$a->timestamp}\'.
...
$string['rate_help_help'] = 'Valore esta pregunta. 1 es muy mala y 5 estrellas es muy buena.';
...
$string['settings_availability_close_answering_from'] = 'Cerrar para respuestas a partir de';
