...
/**
 * Strings for component 'hvp', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   hvp
...
$string['ctcachenolibraries'] = 'Bo se recibió ningun tipo de contenido del Hub H5P. Por favor inténtelo nuevamente más tarde.';
...
$string['enabledlrscontenttypes_help'] = 'Hace psoble el utilizar tipos de contenido que dependen de un Learning Record Store para funcional adecuadamente, como el tipo de contenido de Cuestionario (Questionnaire).';
...
$string['invalidsemanticstype'] = 'WError interno H5P: tipo de contenido desconocido "{$a->@type}" en semántica. ¡Quitando contenido!';
...
$string['invalidxapiresult'] = 'No see encontraron resultados xAPI para la combinación del contenido dado y la ID del usuario';
...
$string['privacy:metadata:hvp_events:content_id'] = 'La ID del contenido sobre del cual fue realizada la acción. 0 si nuevo o sin contenido.';
...
$string['reuseContent'] = 'Re-utilizar Contenido';
$string['reuseDescription'] = 'Re-utilizar este contenido';
...
$string['sendusagestatistics_help'] = 'Los números de estadíisticas de uso se reportarán automáticamente para ayudarle a los desarrolladores a entender mejor como se usa H5P y para determinar áreas potenciales de mejora. Lea más acerca de cuales <a {$a}>datos son colectados en h5p.org</a>.';
