...
/**
 * Strings for component 'portfolio', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   portfolio
...
$string['privacy:metadata:instance'] = 'Identificador para el portafolios.';
$string['privacy:metadata:instancesummary'] = 'Esto almacena ambos, instancias y preferencias, del portafolios para el portafolios que el usuario está usando.';
$string['privacy:metadata:name'] = 'Nombre de la preferencia.';
...
$string['privacy:metadata:portfolio_log:userid'] = 'Usuuario que exportó contenido';
$string['privacy:metadata:portfolio_tempdata'] = 'Almacena temporalmente datos para exportaciones de portafolios, limpiada por cron después de un día';
...
$string['privacy:metadata:userid'] = 'El identificador del usuario.';
