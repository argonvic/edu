...
/**
 * Strings for component 'grades', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   grades
...
$string['aggregationcoefextrasum_help'] = 'Si está marcada la casilla de verificación para Crédito extra, la calificación máxima del ítem de calificación no se agrega a la calificación máxima de la categoría, con el resultado de que es posible alcanzar la calificación máxima en la categoría (o una calificación superior a la máxima si lo ha habilitado el administrador) sin tener la calificación máxima en todos los ítems de calificación.';
...
$string['aggregationcoefweight'] = 'Ponderación del ítem';
$string['aggregationcoefweight_help'] = '<p>Ponderación aplicada a todas las calificaciones en este elemento de calificación durante la agregación con otros ítems de calificación.</p>';
...
$string['decimalpoints'] = 'Número de decimales globales';
...
$string['modgradecantchangegradetype'] = 'Usted no puede cambiar el tipo, porque ya existen calificaciones para este ítem.';
...
$string['modgradecantchangescale'] = 'Usted no puede cambiar la escala, pues ya existen calificaciones para este ítem.';
...
$string['modgradecategoryrescalegrades_help'] = 'Al cambiar las calificaciones máximas en un ítem del Libro de calificaciones, Usted necesita especificar si es que esto causará que cambien también las calificaciones con porcentajes.
...
Por ejemplo, si esta opción se  configura a \'Si\', el cambiar la calificacion máxima en un ítem de 10 a 20 causaría que una calificacion de 6/10 (60%) sea re-escalada a 12/20 (60%). Con esta opción configurada a \'No\', la calificación permanecera sin cambios y necesitaría ajuste manual de los ítems de califcación para asegurar puntuaciones correctas.';
...
Si esto se configura a \'Si\', cualquier calificación existente será re-escalada de foma tal que la calificación en porcentaje permanezca igual.

Por ejemplo, si esta opción se configura a \'Si\', el cambiar la calificación máxima para un ítem de 10 a 20 causará que una calificación de 6/10 (60%) se re-escale a 12/20 (60%).  Con esta opción configurada en \'No\', la calificación cambiaría de 6/10 (60%) a 6/20 (30%), lo que requeriría ajuste manual de los ítems de calificación para asegurarnos de corregir los puntajes.';
...
$string['multfactor_help'] = '<p>Es el factor por el que se multiplicarán todas las calificaciones de este ítem de calificación, con un valor máximo para la calificación del establecido como máximo. Por ejemplo, si el multiplicador es 2 y la calificación máxima es de 100,  todos los grados menores de 50 se multiplican por dos, y todos los grados 50 y superiores se establecerán en 100.</p>';
...
$string['plusfactor_help'] = '<p>Es el valor que se sumará a cada calificación de este ítem de calificación, después de haber aplicado el multiplicador.</p>';
...
$string['privacy:metadata:grade_import_values'] = 'Tabla temporal para impotar calificaciones';
...
$string['privacy:metadata:grade_import_values:importer'] = 'Usuario que impota los datos';
...
$string['range'] = 'Rango';
$string['rangedecimals'] = 'Número de decimales en rango';
$string['rangedecimals_help'] = 'El número de decimales a mostrar para rango.';
$string['rangesdecimalpoints'] = 'Decimales en los rangos';
$string['rangesdecimalpoints_help'] = 'Esta configuración determina el número de decimales a mostrar para cada rango o si es que la configuración de número de decimales global para la categoría o ítem de calificación es usada (heredar).';
...
$string['showhiddenitems_help'] = 'Si están totalmente ocultos los ítems de calificación o si los nombres de los ítems de calificación ocultos son visibles para los estudiantes.

* Mostrar ocultos - Los nombres de los ítems de calificación ocultos se muestran, pero las calificaciones de los estudiante están ocultas
 *Solo permanecen ocultos hasta - Los ítems de calificación con "permanecer oculto hasta" la fecha prevista se ocultan por completo hasta la fecha fijada, después de la cual todos los ítems se muestran
* No mostrar - Los ítems de calificación ocultos están completamente ocultos';
...
$string['showrank_help'] = 'Si es que se muestra o no la posición del estudiante en relación con el resto de la clase para cada ítem de calificación.';
