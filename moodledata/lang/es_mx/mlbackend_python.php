...
/**
 * Strings for component 'mlbackend_python', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['pythonpackagenotinstalled'] = 'El paquete python "moodlemlbackend" no está instalado o hay un problema con él. Por favor ejecute "{$a}" desde la interfaz delínea de comando para más información';
