...
/**
 * Strings for component 'ltiservice_memberships', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['ltiservice_memberships'] = 'Membresía IMS LTI:';
$string['ltiservice_memberships_help'] = 'Permitirle a la herramienta recuperar información de los miembros del curso usando el Servicio de Membresía IMS LTI. Se aplicarán las configuraciones de privacidad.';
$string['notallow'] = 'No usar este servicio';
$string['pluginname'] = 'Servicio Membresía LTI';
$string['privacy:metadata:email'] = 'El Email del usuario que emplea el consumidor LTI.';
$string['privacy:metadata:externalpurpose'] = 'La información es enviada a un provedor LTI externo.';
