...
/**
 * Strings for component 'group', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   group
...
* Son opcionales los campos (así escritos en inglés) groupidnumber, description, enrolmentkey, groupingname (que significan número_ID_del_grupo, descripción, clave de inscripción,nombre_de_agrupamiento)';
