...
/**
 * Strings for component 'tool_messageinbound', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['configmessageinboundhost'] = 'La dirección del servidor contra la que Moodle debería de revisar el correo. Para especificar un puerto no-estándar, use  [servidor]:[puerto], como por ejemplo el formato mail.ejemplo.com:587, Si no se especifica un puerto, se usará el puerto por defecto para el tipo de servidor de correo.';
