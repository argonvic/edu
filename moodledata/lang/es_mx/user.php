...
/**
 * Strings for component 'user', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   user
...
$string['privacy:metadata:emailstop'] = 'Una preferencia para detener el envío de Email al usuario.';
