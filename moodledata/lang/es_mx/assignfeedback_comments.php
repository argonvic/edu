...
/**
 * Strings for component 'assignfeedback_comments', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['commentinlinedefault'] = 'Comentar en línea por defecto';
...
$string['privacy:metadata:gradepurpose'] = 'La ID de calificación asociada con el comentario.';
$string['privacy:metadata:tablesummary'] = 'Esto almacena comentarios hechos por la persona que califica como retroalimentación para el estudiante en sus envíos.';
