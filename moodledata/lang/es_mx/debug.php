...
/**
 * Strings for component 'debug', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   debug
...
$string['cannotbenull'] = '¡ {$a} no puede ser nulo !';
...
$string['nopageclass'] = 'Se importó {$a} pero no encontró clases de página';
