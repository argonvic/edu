...
/**
 * Strings for component 'backup', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   backup
...
$string['recyclebin_desc'] = 'Estas configuraciones también aplicarán par ala papelera de reciclaje';
