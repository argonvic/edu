...
/**
 * Strings for component 'badges', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   badges
...
Nota: Se recomienda dejar esta opción deshabilitada si el sitio web no puede ser accedido desde el Internet (porque hay un cortafuegos \'firewall\').';
...
$string['attachment_help'] = 'Si se activa, una insignia otorgada se anexará al Email del recipiente para que sea descargada. (Deben habilitarse los anexos a Email en Administración del sitio > Plugins > Salidas de mensaje > Email usar esta opción.)';
...
$string['backpackconnectionunexpectedresult'] = 'Hubo un problema al contactar a la Mochila. Por favor, inténtelo nuevamente.<br><br>Si este problema persiste, por favor póngase en contacto con su administrador.';
...
Se ha solicitado una nueva conexión a su mochila de OpenBadges backpack desde \'{$a->sitename}\' usando su dirección Email.

Para confirmarlo y activar la conexión a su mochila, por favor haga clic en el enlace inferior.

{$a->link}

En la mayoría de los programas de correo, esto debería de aparecer como un enlace de color azul al cual Usted puede simplemente hacerle click. Si eso no funcionara, entonces copie y pegue la dirección a la línea para dirección de su navegador web.
...
$string['error:backpackloginfailed'] = 'Usted no pudo conectarse a una mochila externa por la siguiente razón: {$a}';
...
$string['error:badjson'] = 'El intento de conexión regresó datos inválidos.';
...
$string['error:noassertion'] = 'No se regresó ninguna afirmación por Persona. Usted pudo haber cerrado el diálogo antes de completar el proceso para ingresar.';
...
$string['error:personaneedsjs'] = 'Actualmente, se requiere JavaScript para conectar a su mochila. Si puede, habilite JavaScript y vuelva a cargar la página.';
...
$string['personaconnection'] = 'Ingrese con su correo (Email)';
$string['personaconnection_help'] = 'Persona es un sistema para identificarse a Usted mismo en toda la web, empleando una dirección de Emal que Usted posea. La mochila de Open Badges usa Persona como un sistema para ingreso, por lo que, para poder conectarse a una mochila, Usted necesitará una cuenta de Persona.

Para mayor información acerca de Persona, visite <a href="https://login.persona.org/about">https://login.persona.org/about</a>.';
...
$string['signinwithyouremail'] = 'Ingrese con su correo (Email)';
