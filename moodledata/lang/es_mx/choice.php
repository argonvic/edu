...
/**
 * Strings for component 'choice', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   choice
...
$string['limitanswers_help'] = '<p>Esta opción le permite limitar el número de participantes que pueden seleccionar cada opción a elegir.</p> <p>Una vez que se ha activado, cada opción puede fijar un límite. Cuando se alcanza, nadie más puede elegir esa opción. Un límite de cero (0) significa que nadie puede elegir esa opción.</p> <p>Si está desactivada, cualquier número de participantes puede elegir cualquiera de las opciones.</p>';
...
Los resultados de la elección pueden publicarse después de que los estudiantes hayan contestado, o después de cierta fecha, o nunca. Los resultados pueden publicarse junto con los nombres de los estudiantes o de forma anónima.
...
$string['publishinfonever'] = 'Los resultados de esta actividad no serán publicados después de su respuesta.';
