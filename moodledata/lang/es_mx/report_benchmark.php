...
/**
 * Strings for component 'report_benchmark', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['loginguestname'] = 'Tiepo para conectarse con la cuenta de invitado';
$string['loginusermoreinfo'] = 'Midiendo el tiempo usado para cargar la página de ingreso con una cuenta de usuario falsa';
$string['loginusername'] = 'Tiempo para conectarse con una cuenta de usuario falsa';
...
$string['slowharddrivesolution'] = '<ul><li>Revise el estado del Disco Duro / carpeta temp</li><li>Cambie su Disco Duro o la carpeta Temp</li></ul>';
...
$string['slowwebsolution'] = '<ul><li>Borre la Caché de Moodle</a></li></ul>';
