...
/**
 * Strings for component 'cachestore_file', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
- Si Usted sabe que el número de items en la caché será suficientemente pequeño para que no cause problemas en el sistema de archivos con el que corre.<br />
