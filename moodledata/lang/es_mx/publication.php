...
/**
 * Strings for component 'publication', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   publication
...
$string['allowedfiletypes_help'] = 'Los tipos de archivos permitidos pueden ser restringidos al escribir una lista separada por punto_y_coma de mimetipos, como por ejemplo. \'video/mp4; audio/mp3; image/png; image/jpeg\', o extensiones de archivo que incluyan un punto, como por ejemplo \'.png; .jpg\'. Si el campo se deja vacío, entonces todos los tipos de archivo están permitidos.';
