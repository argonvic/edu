...
/**
 * Strings for component 'reader', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   reader
...
$string['averagepointsallterms_help'] = 'El número promedio de puntos otorgados por estudiante para todos los períodos';
$string['averagepointsthisterm'] = 'Promedio de puntos (de este período)';
$string['averagepointsthisterm_help'] = 'El número promedio de puntos otorgados por estudiante para este período';
...
$string['averagewordsallterms_help'] = 'El número promedio de palabras otorgadas por estudiante en todos los períodos';
$string['averagewordsthisterm'] = 'Promedio de palabras (de este período)';
$string['averagewordsthisterm_help'] = 'El número promedio de palabras otorgadas por estudiante en este período';
...
$string['sendmessage'] = 'Enviar mensaje a estudiantes seleccionados';
...
$string['setlevels_description'] = 'En esta página Usted puede configurar los niveles de lectura para grupos de estudiantes. Tenga en cuenta que estas configuraciones anularán las configuraciones para estudiantes individuales en las páginas de reportes.';
