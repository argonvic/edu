...
/**
 * Strings for component 'moodle', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   moodle
...
$string['coursenotyetfinished'] = 'El curso todavía no está terminado';
$string['coursenotyetstarted'] = 'El curso todavía no está iniciado';
$string['courseoverview'] = 'Vista general del curso';
$string['courseoverviewfiles'] = 'Archivos del resumen del curso';
$string['courseoverviewfilesext'] = 'Extensiones para archivos del resumen del curso';
$string['courseoverviewfiles_help'] = 'Los archivos del resumen del curso, tales como imágenes,  son mostrados en la lista de cursos junto con el resumen';
$string['courseoverviewfileslimit'] = 'Límite para archivos del resumen del curso';
...
$string['dndnotsupported_help'] = 'Su navegador no soporta la subida por \'arrastrar y soltar\' (drag and drop). <br />Esta característica está disponible en todas las versiones recientes de Chrome, Firefox y Safari, al igual que en Internet Explorer versión 10 y superiores.';
...
$string['emaildisplayhidden'] = 'Correo oculto';
...
$string['extendenrol'] = 'Ampliar inscripción (individual)';
...
Este programa es software gratuito; usted puede redistribuirlo y/o modificarlo bajo los términos de GNU General Public License según la publicación de The Free Software Foundation; incluso la versión 2, o ( a su elección) alguna posterior.

El programa se distribuye en la esperanza de que resulte útil, pero SIN GARANTÍA ALGUNA; incluso la garantía implicada de DISTRIBUCIÓN MERCANTIL o AJUSTE A UN PROPÓSITO PARTICULAR.
...
$string['groupextendenrol'] = 'Inscripción extendida (común)';
...
$string['indicator:accessesafterend'] = 'Accesos al curso después de la fecha de terminación';
$string['indicator:accessesafterend_help'] = 'Este indicador refleja si acaso el estudiante accedió al curso después de la fecha de terminación del curso.';
$string['indicator:accessesbeforestart'] = 'Accesos al curso antes de la fecha de inicio';
$string['indicator:accessesbeforestart_help'] = 'Este indicador refleja si acaso el estudiante accedió al curso antes de la fecha de finicio del curso.';
$string['indicator:anywrite'] = 'Cualquier acción de escribir';
...
$string['logout'] = 'Salir';
$string['logoutconfirm'] = '¿Realmente desea Usted desconectarse?';
...
$string['makeeditable'] = 'Si \'{$a}\' tiene los permisos editables (CHMOD 777), usted puede editar este archivo desde esta página.';
$string['makethismyhome'] = 'Hacer esta mi página de inicio por defecto';
...
$string['maxsizeandattachments'] = 'Tamaño máximo para archivos nuevos: {$a->size}, anexos máximos: {$a->attachments}';
$string['maxsizeandattachmentsandareasize'] = 'Tamaño máximo para archivos nuevos: {$a->size}, máximo para anexos: {$a->attachments}, límite general: {$a->areasize}';
$string['memberincourse'] = 'Personas en el curso';
$string['messagebody'] = 'Cuerpo del mensaje';
$string['messagedselectedcountusersfailed'] = 'Ocurrió un problema y {$a} mensajes no se han enviado.';
$string['messagedselecteduserfailed'] = 'El mensaje no se envió al usuario  {$a->fullname}.';
...
$string['modvisible_help'] = 'Si la disponibilidad se configura a \'Mostrar en página de curso\', la actividad o el recurso está disponible para estudiates (sujeto a cualesquier restricciones de acceso que puedan configurarse).<br><br>
...
$string['modvisiblehiddensection_help'] = 'Si la disponibilidad se configura a \'Ocultarle a los estudiantes\', la actividad o el recurso solamente está disponible para usuarios con permiso para ver actividades ocultas (por defecto, usuarios con el rol de profesor o profesor sin derechos de edición).<br><br>
Si el curso contiene muchas actividades o recursos, la página del curso puede ser simplificada al configurar la disponibilidad a \'Hacer disponible pero no mostrado en página del curso\'. En este caso, eproporcionarse un enlace hacia la actividad o el recurso desde otro lado, como por ejemplo desde un recurso página. La actividad todavía estará enlistada en el Libro de calificaciones y otros reportes.';
$string['modvisiblewithstealth'] = 'Disponibilidad';
$string['modvisiblewithstealth_help'] = 'Si la disponibilidad se configura a \'Mostrar en página del curso\', la actividad o recurso está disponible para estudiantes (sujeta a cualquier restricción de disponibilidad que se pueda configurar).<br><br>
Si la disponibilidad se configura a \'Ocultarle a estudiantes\', la actividad o recurso solamente está disponible para usuarios con permiso para ver actividades ocultas (por defecto, usuarios con el rol de profesor o profesor sin derechos de edición).<br><br>
...
$string['mustconfirm'] = 'Necesita confirmar su ingreso';
...
$string['nocourseactivity'] = 'No hay suficiente actividad del curso entre las fechas de inicio y término del curso';
$string['nocourseendtime'] = 'El curso todavía no tiene una fecha de término';
...
$string['notifyloginfailuressubject'] = '{$a} :: Notificación de intentos de ingreso fallidos';
...
$string['now'] = 'ahora';
$string['numattempts'] = '{$a} intento(s) de ingreso fallido(s)';
...
$string['outlinereport'] = 'Esquema de reporte';
$string['page'] = 'Página';
...
$string['registrationno'] = 'No, no quiero recibir ningún Email de Moodle HQ';
$string['registrationsend'] = 'Enviar mi información de registro a moodle.org';
$string['registrationyes'] = 'Si, notifícarme sobre cosas importantes (seguridad, versiones)';
...
$string['searchhelp'] = '<p>Puede buscar muchas palabras al mismo tiempo y puede refinar su búsqueda como sigue:.</p><ul>
...
$string['selectmoduletoviewhelp'] = 'Elija una actividad o recurso para ver su ayuda asociada.

Haga doble click sobre una actividad o recurso para añadirla rápidamente.';
...
$string['sitemessage'] = 'Mensajear usuarios';
...
$string['target:coursedropout_help'] = 'Este objetivo describe si es que el estudiante está considerado en riesgo de abandonar.';
$string['targetlabelstudentdropoutno'] = 'No-en-riesgo';
$string['targetlabelstudentdropoutyes'] = 'Estudiantes en riesgo de abandonar';
$string['targetlabelteachingno'] = 'Sin enseñar';
$string['targetlabelteachingyes'] = 'Usuarios con capacidad de enseñar tienen acceso al curso';
$string['target:noteachingactivity'] = 'Sin enseñar';
$string['target:noteachingactivity_help'] = 'Este objetivo describe si es que los cursos que están puestos para iniciar en la próxima semana tendrán actividad de enseñanza.';
...
$string['timesplitting:decilesaccum_help'] = 'El método para dividir el tiempo divide el curso en décimos (10 partes iguales), y cada predicción está basada en los datos de todos los deciles previos.';
$string['timesplitting:deciles_help'] = 'El método para dividir el tiempo divide el curso en décimos (10 partes iguales), y cada predicción está basada en los datos de solamente el decil previo más reciente.';
$string['timesplitting:nosplitting'] = 'Sin división del tiempo';
$string['timesplitting:nosplitting_help'] = 'No está definido ningun mértodo para dividir el tiempo para este modelo.';
$string['timesplitting:quarters'] = 'Cuartiles';
$string['timesplitting:quartersaccum'] = 'Cuartiles acumulativos';
$string['timesplitting:quartersaccum_help'] = 'El método de división del tiempo divide el curso en cuartos (4 partes iguales), donde cada predicción está basada en los datos de todos los cuartos anteriores.';
$string['timesplitting:quarters_help'] = 'El método de división del tiempo divide el curso en cuartos (4 partes iguales), donde cada predicción está basada solamente en los datos de del cuarto anterior más reciente.';
$string['timesplitting:singlerange'] = 'Rango simple';
$string['timesplitting:singlerange_help'] = 'Este método de división del tiempo considera a todo el curso como un solo período.';
$string['timesplitting:weekly'] = 'Semanal';
$string['timesplitting:weeklyaccum'] = 'Semanal acumulativo';
$string['timesplitting:weeklyaccum_help'] = 'Este método de división del tiempo divide al curso ensemanas (7 días), donde  cada predicción está basada en los datos de todas las semanas anteriores.';
$string['timesplitting:weekly_help'] = 'Este método de división del tiempo divide al curso ensemanas (7 días), donde  cada predicción está basada solamente en los datos de la semana anterior más reciente.';
...
$string['usemessageform'] = 'o utilice el formato de más abajo para enviar un mensaje a los estudiantes seleccionados';
$string['user'] = 'Usuario';
...
$string['userfilterplaceholder'] = 'Palabra_clave a buscar o seleccionar filtro';
