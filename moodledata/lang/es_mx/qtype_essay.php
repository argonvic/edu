...
/**
 * Strings for component 'qtype_essay', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   qtype_essay
...
$string['graderinfoheader'] = 'Información del calificador';
...
$string['pluginname_help'] = 'En respuesta a una pregunta, el alumnopuede subir uno omás archivos o puede ingresar tesxto en-línea . Se puede proporcionar una plantilla de respuesta. Las respuestas deben ser calificadas manualmente.';
...
$string['privacy:metadata'] = 'El plugin de tipo de pregunta Ensayo no almacena ningún dato personal.';
