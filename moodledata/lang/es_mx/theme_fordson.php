...
/**
 * Strings for component 'theme_fordson', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['choosereadme'] = 'Fordson proporciona una experiencia visual única al tema Boost por defecto, con características de personalización tales como selectores de color y experiencia de página inicial mejorada.';
...
$string['commonlyused'] = 'Módulos de recurso y actividad personalizados.';
$string['commonlyuseddesc'] = 'Lista separada por comas de los nombres en idioma inglés de actividades/recursos para enlistarse en la parte superior del Selector de Actividades/Recursos.<br>
Actividades por defecto:<br>
assign,chat,choice,data,feedback,forum,glossary,lesson,lti,quiz,scorm,survey,wiki,workshop<br>
Recursos por defecto:<br>
...
$string['coursetilestyle_desc'] = 'Cuando se ven categorías de curso, Usted puede elegir entre los estilos siguientes para mostrar cursos.  <a href="https://goo.gl/fMXzSo" target="_new">Instrucciones para Tema Fordson 3.5</a>';
...
$string['frontpagemycoursessorting'] = 'Ordenamiento por Último Acceso de Mis Cursos en la Portada';
$string['frontpagemycoursessorting_desc'] = 'Cuando se activa, esta característica ordenará la visualización de la Portada para Mis Cursos (cursos inscritos) por el último acceso del usuario. Esto anulará la configuración de "Ordenar mis cursos" de la Navegación. Si no se seleccionara, entonces Mis Cursos en la Portada se mostrará como normalmente es.';
...
$string['modchoosercommonlyused'] = 'Comunmente usado';
$string['modchoosercommonlyusedtitle'] = 'Módulos Comunes';
$string['modchoosercommonlyusedtitlecustom'] = '{$a}';
$string['modchoosercustomlabel'] = 'Etiqueta Selector Personalizada';
$string['modchoosercustomlabel_desc'] = 'Añadir su propia etiqueta personalizada para este menú nuevo en el panel del Módulo Selector.';
...
$string['preset_desc'] = 'Elegir una preconfiguración para cambiar ampliamente la apariencia del tema.  <a href="https://goo.gl/fMXzSo" target="_new">Instrucciones para Tema Fordson 3.5</a>';
...
$string['sectionlayout_desc'] = 'Elija entre los siguientes estilos de sección de tópico/semana. <a href="https://goo.gl/fMXzSo" target="_new">Instrucciones para Tema Fordson 3.5 </a>';
...
$string['showalltomanager'] = 'Mostrarle Todas las Actividades y Recursos a Mánagers';
$string['showalltomanager_desc'] = 'Esta configuración le permitirá a los usuarios que tengan el rol de Mánager  que vean y accedan a TODAS las actividades y recursos, aun y cuando estuviera configurado a mostrar solamente el menú personalizado. Generalmente, un rol de mánager es dado a un usuario al nivel del sitio o de la categoría. Los profesores todavía verán solamente el menú personalizado. Esta característica está determinada por el permiso de usuario para Ver el Árbol de Administración del Sitio  - moodle/site:configview . Los administradores del sitio siempre verán todas las actividades y los recursos.';
...
$string['showonlycustomactivities'] = 'Mostrar Solamente Menú Personalizado';
$string['showonlycustomactivities_desc'] = 'Si se activa, solamente se mostrará el menú personalizado. Esto le permite a una organización el seleccionar y elegir cuales actividades y recursos se usarán en cursos. ADVERTENCIA: Usted debe de tener una lista separada por comas de los nombres en idioma inglés de las actividades y los recursos configurada en la caja_de_texto de arriba. En caso contrario, Usted no verá ninguna actividad ni ningún recurso cuando edite un curso.';
...
$string['slideshowheight_desc'] = 'Ajustar la altura del Carrousel.';
