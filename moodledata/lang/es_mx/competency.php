...
/**
 * Strings for component 'competency', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   competency
...
$string['eventusercompetencyrated'] = 'Competencia del usario valorada.';
$string['eventusercompetencyratedincourse'] = 'Competencia del usario valorada en curso.';
$string['eventusercompetencyratedinplan'] = 'Competencia del usario valorada en un plan de aprendizaje.';
...
$string['eventuserevidencecreated'] = 'Evidencia de conocimiento previo creada.';
...
$string['invalidpersistent'] = 'Persistente inválido';
...
$string['privacy:evidence:action:complete'] = 'Completar competencia si no_valorada';
$string['privacy:evidence:action:log'] = 'Guardar acción en biitácora';
...
$string['privacy:metadata:evidence:note'] = 'Una nota no-localizada anexada a la evidencia';
...
$string['privacy:metadata:plan:userid'] = 'La ID del usuario de quien es el plan de parendizaje';
