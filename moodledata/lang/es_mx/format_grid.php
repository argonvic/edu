...
/**
 * Strings for component 'format_grid', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   format_grid
...
$string['defaultcoursedisplay'] = 'Valores por defecto para mostrar curso';
$string['defaultcoursedisplay_desc'] = 'Ya sea que muestre todas las secciones en una sola página o que muestre la sección cero y la sección elegida en la página.';
...
$string['formatgrid'] = 'Formato rejilla (Grid)';
...
$string['imagefile_help'] = 'Subir una imagen de tipo PNG, JPG o GIF';
...
$string['pluginname'] = 'Formato Rejilla (Grid)';
...
$string['resetgreyouthidden_desc'] = 'Reiniciar la propiedad \'Vista Rejilla muestra imágenes de sección no-disponible en gris y no-enlazada.\\';
...
$string['setshowsectiontitlesummaryposition_help'] = 'Configurar la posición del resumen del título de sección a mostrar cuando se pasa el ratón encima sobre de la rejilla a uno de cuatro posibles \'superior\', \'inferior\', \'izquierda\' o \'derecha\'.';
