...
/**
 * Strings for component 'qtype_ddmarker', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['dropzones_help'] = 'Las zonas de soltar están definidas al escribir coordenadas. Al tiempo que Usted escribe, se actualiza inmediatamente la zona de previsualización arriba, para que Usted pueda posicionar las cosas por ensayo y error.
...
* Rectángulo: x_izquierda_superior,  y_izquierda_superior, altura<br>por ejemplo: <code>20, 60; 80, 40</code>';
$string['followingarewrong'] = 'Los siguientes marcadores han sido colocados en el área equivocada : {$a}.';
$string['followingarewrongandhighlighted'] = 'Los siguientes marcadores fueron colocados equivocadamente: {$a}. Marcador(es) resaltado(s) se muestra(n) con la ubicación correcta.<br /> Elija el marcador para resaltar el área permitida..';
