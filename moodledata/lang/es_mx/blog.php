...
/**
 * Strings for component 'blog', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   blog
...
$string['filtertags'] = 'Filtrar marcas';
$string['filtertags_help'] = 'Usted puede emplear esta característica para filtrar las entradas que desea usar. Si especifica marcas aquí (separadas por comas) entonces únicamente las entradas con estas marcas serán copiadas desde el blog externo.';
...
$string['privacy:metadata:core_tag'] = 'Marcas asociadas con entradas del blog';
...
$string['privacy:metadata:external:filtertags'] = 'La lista de marcas con las cuales filtrar las entradas';
...
$string['privacy:metadata:external:userid'] = 'La ID del usuario que añadió la entrada de blog externa';
...
$string['privacy:metadata:post:userid'] = 'La ID del usuario que añadió la entrada de blog';
