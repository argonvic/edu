...
/**
 * Strings for component 'tool_coursearchiver', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['errornonnumericaccess'] = 'El acceso debe ser numérico (sello de tiempo  UNIX)';
