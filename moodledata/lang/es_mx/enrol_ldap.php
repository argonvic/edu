...
/**
 * Strings for component 'enrol_ldap', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   enrol_ldap
...
$string['autoupdate_settings_desc'] = '<p>Seleccione campos a actualizar cuando se está ejecutando el script de sincronización (enrol/ldap/cli/sync.php).</p><p>Cuando esté seleccionado al menos un campo, ocurrirá una actualización.</p>';
