...
/**
 * Strings for component 'cache', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   cache
...
$string['cachedef_message_time_last_message_between_users'] = 'Hora de creación para mensajes más recientes entre usuarios';
...
$string['cachedef_plugin_functions'] = '\'Callbacks\' (llamadas de retorno) de plugins disponibles';
