...
/**
 * Strings for component 'auth_saml', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   auth_saml
...
$string['auth_saml_errorsp_source'] = 'El orígen del Provedor del servicio SimpleSAMLPHP {\\$a} no es correcto';
