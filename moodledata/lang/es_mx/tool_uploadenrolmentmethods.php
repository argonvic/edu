...
/**
 * Strings for component 'tool_uploadenrolmentmethods', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
* Los campos obligatorios son: operation, enrolment method, target course shortname, parent course shortname or cohort idnumber, disabled status, group name (operación, método de inscripción, nombre_corto de curso destino, nombre_corto de curso paterno o númeroID de cohorte, estado_deshabilitado, nombre_del_grupo).
...
$string['toofewcols'] = '{$a->line} {$a->linenum}: Demasiado pocas columnas, se esperaban 6. {$a->skipped}.';
$string['toomanycols'] = '{$a->line} {$a->linenum}: Demasiadas columnas, se esperaban 6. {$a->skipped}.';
