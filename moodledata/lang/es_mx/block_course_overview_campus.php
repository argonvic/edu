...
/**
 * Strings for component 'block_course_overview_campus', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['activityoverview'] = 'Usted tiene {$a}s que requieren su atención';
$string['all'] = 'Todos';
...
$string['categorycoursefilterdisplayname_desc'] = 'Este nombre a mostrar se muestra arriba del filtro de categoría<br /><em>Esta configuración solamente es procesada cuando se activa el filtro de categoría</em>';
$string['categorycoursefiltersettingheading'] = 'Filtro de categoría paterna: Activación de filtro';
$string['coursenewsdefault'] = 'Ocultar novedades del curso por defecto';
$string['coursenewsdefault_desc'] = 'Si se habilita, las novedades del curso estarán ocultas por defecto, para evitar listas amontonadas de cursos. Si se dehabilita, se muestran las novedades del curso por defecto, para captar la atención dle usuario. Tan pronto como un usuario oculta / muestra las novedades del curso, esta configuración ya no será relevante para este curso.<br /><em>Esta configuración solamente es procesada cuando está activado  el habilitar novedades del curso</em>';
$string['coursenewsheading'] = 'Novedades del curso';
...
$string['enablecoursenews'] = 'Habilitar novedades del curso';
$string['enablecoursenews_desc'] = 'Habilitar novedades del curso debajo del nombre del curso en la lista de cursos si hubiera novedades en el curso';
...
$string['hidenews'] = 'Ocultar novedades de cursos';
$string['listentriessettingheading'] = 'Lista de vista general del curso: Entradas';
$string['managehiddencourses'] = 'Gestionar cursos ocultos';
$string['mergehomonymouscategories'] = 'Unir categorías homónimas';
$string['mergehomonymouscategories_desc'] = 'Si hay múltiples categorías con diferentes categorías padre, pero con el mismo nombre, el filtro de categoría se llenará con múltiples categorías con el mismo nombre por defecto. Esto podría confundir al usuario. Si Usted quiere juntar todas las categorías homónimas dentro de una categoría al usar el filtro de categoría, active esta configuración<br /><em> Esta configuración solamente es procesada cuando está activado el filtro de categoría</em>';
$string['mergehomonymouscategoriessettingheading'] = 'Filtro de categoría: Unir categorías homónimas';
...
$string['privacy:metadata:preference:hidenews'] = 'El estado mostrar/ocultar de las novedades de un curso en la lista de vista general de curso.';
...
$string['privacy:request:preference:hidenews'] = 'El estado mostrar/ocultar del curso {$a->item} en la lista de vista general de novedades del curso es: {$a->value}.';
...
$string['secondrowshowcategoryname'] = 'Segunda fila: Mostrar nombre de categoría';
$string['secondrowshowcategoryname_desc'] = 'Mostrar el nombre de la categoría del curso en una segunda hilera de la entrada de lista de vista general del curso';
...
$string['settingspage_coursenews'] = 'Novedades del curso';
...
$string['shownews'] = 'Mostrar novedades del curso';
$string['skipcoursenews'] = 'Saltar novedades del curso';
$string['skipcoursenews_desc'] = 'Al colectar y mostrar novedades del curso, las novedades de las actividades seleccionadas serán saltadas<br /><em>Esta configuración solamente es procesada cuando están activadas las novedades del curso</em>';
$string['stopmanaginghiddencourses'] = 'Dejar de gestionar cursos ocultos';
...
$string['termyearpos_desc'] = 'Definir si el año del período debería de añadirse como sufijo (posterior a) o prefijo (anterior) al nombre del período <br /><em>Esta configuración solamente es procesada cuando está activado el filtro de profesor</em>';
...
$string['termyearseparation_desc'] = 'Si la duración del período incluye el día de Año Nuevo, definir cómo este segundo año debería de separarse del primero<br /><em><Esta configuración solamente es procesada cuando está activado el filtro de profesor</em>';
