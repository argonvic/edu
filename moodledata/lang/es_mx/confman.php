...
/**
 * Strings for component 'confman', language 'es_mx', branch 'MOODLE_34_STABLE'
 *
 * @package   confman
...
$string['item:title_post'] = 'Título (después del nombre)';
$string['item:title_pre'] = 'Título (antes del nombre)';
