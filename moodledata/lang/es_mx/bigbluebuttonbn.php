...
/**
 * Strings for component 'bigbluebuttonbn', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['config_meetingevents_enabled'] = 'Registrar eventos de reunión';
$string['config_meetingevents_enabled_description'] = 'La característica de registrar eventos de reunión está habilitada.';
...
$string['config_recordingready_enabled'] = 'Notificaciones cuando grabación lista está habilitada';
$string['config_recordingready_enabled_description'] = 'Notificaciones cuando la característica de grabación lista está habilitada';
...
$string['config_sendnotifications_enabled_description'] = 'La característica de enviar notificaciones está habilitada en la Interfaz del usuario cuando la sala o conferencia es añadida o actualizada.';
...
$string['config_warning_bigbluebuttonbn_cfg_deprecated'] = 'BigBlueButtonBN está haciendo uso de config.php con una variable global que ha sido deprecada. Por favor convierta el archivo, ya que no será soportado en versiones futuras';
...
$string['mod_form_block_recordings'] = 'Configuraciones de Grabación';
