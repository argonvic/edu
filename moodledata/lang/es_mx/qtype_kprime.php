...
/**
 * Strings for component 'qtype_kprime', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['scoringmethod_help'] = '<strong>Kprime:</strong> El estudiante recibe un punto si todas las respuestas son correctas, medio punto si todas excepto una están correctas, y cero punto en los demás casos.<br/><strong>Kprime 1/0:</strong> El estudiante recibe un punto si todas las respuestas están correctas, y cero puntos en otros casos.
