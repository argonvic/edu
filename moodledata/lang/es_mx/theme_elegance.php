...
/**
 * Strings for component 'theme_elegance', language 'es_mx', branch 'MOODLE_31_STABLE'
 *
...
$string['android'] = 'Descargue la App de Android desde Google Play';
$string['androiddesc'] = 'Proporcione una URL hacia su App mobile App en la tienda Google Play Store. Si Usted no tiene una App propia considere enlazar hacia a App oficial Moodle Mobile. (https://play.google.com/store/apps/details?id=com.moodle.moodlemobile)';
...
$string['customlinkicondesc'] = 'Nombre del ícono que desea usar junto a su enlace.<br> La lista está <a href="http://fortawesome.github.io/Font-Awesome/icons/" target="_new">aquí</a>.Simplemente escriba lo que sigue después de "fa-".';
...
$string['enableeditprofiledesc'] = 'Mostrarun enlace para editar el perfil del usuario.';
...
$string['ios'] = 'Descargar la App para iPhone/iPad desde la tienda de Apps';
$string['iosdesc'] = 'Proporcione una URL hacia su App mobile en la tienda de App. Si no tiene una propia entonces considere enlazar hacia la App oficial Moodle Mobile (https://itunes.apple.com/en/app/moodle-mobile/id633359593).';
...
$string['mobileappsdesc'] = '¿Ha obtenido una App web en la tienda de Apps o de Google Play? Proporcione aquí un enlace para que los usuarios puedan obtener la App en-línea.';
$string['mobileappsheading'] = 'App Mobile';
$string['mobileappsheadingsub'] = 'Enlace hacia su App para permitirles a sus estudiantes usar dispositivos móviles';
...
$string['usermenulinks'] = 'Número de Enlaces Personalizados';
...
$string['windows'] = 'Descargue la App para escritorio desde la tienda de Windows';
$string['windowsdesc'] = 'Proporcione una URL hacia su App Mobile en la Tienda de Windows. Si no tiene una App propia, considere enlazar a la App Oficial Moodle Mobile. (http://apps.microsoft.com/windows/en-us/app/9df51338-015c-41b7-8a85-db2fdfb870bc)';
$string['windowsurl'] = 'Escritorio de windows';
$string['winphone'] = 'Descargue la App mobile desde la tienda Windows';
$string['winphonedesc'] = 'Proporcione una URL hacia su App Mobile en la Tienda de Windows. Si no tiene una App propia, considere enlazar a la App Oficial Moodle Mobile. (http://www.windowsphone.com/en-us/store/app/moodlemobile/d0732b88-3c6d-4127-8f24-3fca2452a4dc)';
