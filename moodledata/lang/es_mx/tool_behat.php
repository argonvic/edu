...
/**
 * Strings for component 'tool_behat', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   tool_behat
...
$string['fieldvalueargument_help'] = 'Este argumento debería ser completado por un valor de campo. Hay muchos tipos de campos: los sencillos como las casillas de verificación, selecciones o área-de-texto; o campos  complejos como los selectores de datos. Usted puede revisar la documentación para desarrolladores <a href="http://docs.moodle.org/dev/Acceptance_testing" target="_blank">Acceptance_testing</a> para ver los detalles de los valores de campo esperados.';
