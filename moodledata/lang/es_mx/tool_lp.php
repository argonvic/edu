...
/**
 * Strings for component 'tool_lp', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   tool_lp
...
$string['averageproficiencyrate'] = 'La tasa de pericia/dominio promedio para planes de aprendizaje completados basada en esta plantilla es {$a} %';
...
$string['competencyoutcome_none'] = 'Nada/ninguna';
...
$string['movecompetencytochildofselfwillresetrules'] = 'El mover la competencia quitará su propia regla, y las reglas configuradas en sus padres y su destino. ¿Desea continuar?';
