...
/**
 * Strings for component 'role', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   role
...
$string['backup:backuptargethub'] = 'Respaldar para publicar en Moodle.net';
...
$string['community:add'] = 'Usar el bloque comunidad para buscar Moodle.net y encontrar cursos';
...
$string['course:publish'] = 'Publicar un curso';
...
$string['restore:restoretargethub'] = 'Restaurar cursos descargados de Moodle.net';
