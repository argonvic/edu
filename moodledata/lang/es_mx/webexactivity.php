...
/**
 * Strings for component 'webexactivity', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
Cuando Usted añade la actividad WebEx Meeting, Usted define la fecha y hora de la reunión, y varios parámetros opcionales (tales como duración esperada, una descripción, etc). Los participantes (estudiantes inscritos) pueden entonces Ingresar a la reunión WebEx al hacer clic en un enlace para "Unirse a reunión" debajo de la actividad en Moodle (los profesores verán un enlace que dice "Alojar Reunión"). Si la reunión es grabada, los estudiantes podrán ver la grabación después  de que termine la reunión.
