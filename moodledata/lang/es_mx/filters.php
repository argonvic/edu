...
/**
 * Strings for component 'filters', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   filters
...
$string['limiterfor'] = '{$a} limitador de campo';
...
$string['profilefilterfield'] = 'Nombre del campo de perfil';
$string['profilefilterlimiter'] = 'Operador del campo del perfil';
