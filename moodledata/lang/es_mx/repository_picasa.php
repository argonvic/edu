...
/**
 * Strings for component 'repository_picasa', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['privacy:metadata:repository_picasa'] = 'El plugin del Repositorio album web Picasa no almacena ningún dato personal, pero si transmite datos del usuario desde Moodle hacia un sistema remoto.';
$string['privacy:metadata:repository_picasa:searchtext'] = 'La consulta de texto de búsqueda del usuario de repositorio Picasa.';
