...
/**
 * Strings for component 'simplelesson', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['add_question_page'] = 'Activar las casillas para añadir las preguntas seleccionadas a esta Lección simple. Usted puede cambiar la categoríia en las configuraciones para añadir preguntas desde múltiples categorías. SUGERENCIA: Póngales nombres sensatos a sus preguntas al crearlas,; hará la vida más fácil.';
$string['allocate_mark'] = 'Asignar un puntaje para el ensayo';
$string['allowincomplete'] = 'Permitir intentos incompletos';
$string['allowincomplete_help'] = 'Activar para forzar a los estudiantes a que respondan a una pregunta antes de que sean mostrados los enlaces de navegación.';
...
$string['attemptcompleted'] = 'Intento de lección simple iniciado';
...
$string['categoryid_help'] = 'Elija una categoría para las preguntas que pueden ser añadidas a la lecciónsimple. Usted puede regresar aquí más tarde y añadir otras categorías desde las configuraciones del módulo.';
...
$string['delete_page'] = 'Eliminar página';
$string['editing'] = 'Gestionar lección:';
$string['edit_page'] = 'Editar página';
$string['edit_page_form'] = 'Editar los contenidos de la página';
$string['edit_question_page'] = 'Haga click en el enlace para Asignar en la última columna para asignar preguntas a páginas (solamente se permite una pregunta por página). Usted también puede configurar el puntaje para una pregunta.';
...
$string['getnextpage'] = 'Página siguiente';
$string['getprevpage'] = 'Página anterior';
$string['gotoaddpage'] = 'Añadir página';
$string['gotodeletepage'] = 'Eliminar página';
$string['gotoeditpage'] = 'Editar página';
$string['gotonextpage'] = 'Siguiente';
$string['gotoprevpage'] = 'Anterior';
...
$string['hasquestion'] = 'Tiene pregunta';
$string['homelink'] = 'Página inicial';
...
$string['managing'] = 'Gestionar páginas:';
...
$string['modulename_help'] = 'Use el módulo de Lección Simple para una visualización secuencial simple de páginas con un índice opcional. El módulo simplelesson permite la creación y adición de múltiples páginas de contenido.

Se permite el uso de preguntas de un banco de preguntas seleccionado. Los tipos de pregunta válidos que han sido probados son Falso/Verdadero, opción múltiple (una respuesta), relación de columnas, seleccionar hueco y respuesta corta. Las preguntas de ensayo están permitidas y necesitan ser calificadas manualmente. Los comportamientos de pregunta implementados son adaptativo, retroalimentación inmediata y diferida (sin PBC).

Los datos del intento del usuario, incluyendo las respuestas  detalladas a preguntas, son grabados y calificados. Las estrategias de calificación usadas para intentos múltiples son: La más alta, Promedio y Los últimos intentos.

Simplelesson y sus páginas de contenido son respaldados, pero las preguntas no son respaldadas.';
...
$string['pluginadministration'] = 'Administración de Lecciónsimple';
$string['pluginname'] = 'Lección simple';
$string['preview'] = 'Vista previa';
$string['previewcompleted'] = 'Vista previa completada';
...
$string['question_adding'] = 'Añadiendo preguntas a Lección simple';
$string['question_editing'] = 'Editando preguntas';
$string['question_exists'] = 'Esa página ya tiene una pregunta';
...
$string['removeallgroupoverrides'] = 'Quitar anulaciones de grupo';
$string['removealluseroverrides'] = 'Quitar anulaciones de usuario';
$string['reportstab'] = 'reportes';
$string['requires_grading'] = 'Necesita calificación';
$string['rightanswer'] = 'Respuesta correcta';
$string['save'] = 'Guardar';
$string['saveanswer'] = 'Guardar ensayo';
$string['selecting_page'] = 'Seleccionar la página para pregunta:';
...
$string['showindex_help'] = 'El índice de página es opcional y se mostrará por defecto en la parte superior derecha de todas las páginas de contenido. Esto puede ser sobrescrito por los temas.';
...
$string['simplelesson:exportpages'] = 'Exportar páginas de reportes';
...
$string['simplelesson:importpages'] = 'Exportar páginas de reportes';
...
$string['timetaken'] = 'Tiempo (s)';
$string['title'] = 'Título de página';
