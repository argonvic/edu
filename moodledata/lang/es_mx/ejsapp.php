...
/**
 * Strings for component 'ejsapp', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
 * @package   ejsapp
...
$string['display_lab_charts'] = 'Mostrar las gráficas del laboratorio EjsS';
$string['display_lab_control'] = 'Mostrar los controles del laboratorio EjsS';
$string['display_lab_execution'] = 'Mostrar las funciones corriendo del laboratorio EjsS';
...
$string['server_id'] = 'ID del sitio en Sarlab';
$string['server_id_description'] = 'ID usada para registrar este sitio Moodle enSarlab IRS (http://sarlabirs.dia.uned.es). Déjelo vacío si el sitio no está registrado';
