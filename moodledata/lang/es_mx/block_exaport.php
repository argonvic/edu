...
/**
 * Strings for component 'block_exaport', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['autofillview'] = 'Auto-generar una vista basada en los artefactos disponibles';
...
$string['resume_template_newresume'] = '<h2>Mi nuevo curriculum</h2>';
...
$string['share_to_other_users'] = 'Compartir con otros usuarios que no están en mis cursos';
$string['sharetoteacher'] = 'Compartirlo con el profesor del curso';
$string['show'] = 'Mostrar';
