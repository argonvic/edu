...
/**
 * Strings for component 'block_rss_client', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['timeout'] = 'Tiempo en minutos antes de que un canal RSS expire en la caché. Sepa que este tiempo define el intervalo mínimo de tiempo antes de caducar; el canal se refrescará en la caché en la siguiente ejecución del cron después de caducar. Valores recomendados son 30 minutos o mayores.';
$string['timeout2'] = 'Tiempo de espera';
$string['timeoutdesc'] = 'Tiempo de permanencia de un canal de noticias en la caché (en minutos)';
