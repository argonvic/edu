...
/**
 * Strings for component 'logstore_standard', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['buffersize'] = 'Tamaño de buffer de escritura';
$string['pluginname'] = 'Bitácora estándar';
$string['pluginname_desc'] = 'Un plugin de bitácora almacena entradas de bitácora dentro de una tabla de BasedeDatos de Moodle.';
...
$string['privacy:metadata:log:realuserid'] = 'La Id del usuario real detrás del evento cuando esta enmascarado como un usuario.';
$string['privacy:metadata:log:relateduserid'] = 'La ID de un usuario relacionado a este evento';
...
$string['taskcleanup'] = 'Limpieza de tablas de bitácoras';
