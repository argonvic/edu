...
/**
 * Strings for component 'filter_mathjaxloader', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['privacy:metadata'] = 'El plugin Mathjax no almacena ningún dato personal.';
