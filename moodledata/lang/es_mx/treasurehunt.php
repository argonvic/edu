...
/**
 * Strings for component 'treasurehunt', language 'es_mx', branch 'MOODLE_35_STABLE'
 *
...
$string['cleartreasurehunt_done'] = 'La actividad se ha re-inicializado. Toda la actividad de los participantes se ha eliminado.';
...
$string['grouplocationfailed'] = 'Ubicación fallida por {$a->user} de la etapa {$a->position} en la fecha: {$a->date}';
$string['grouplocationovercome'] = 'Ubicación encontrada por {$a->user} de la etapa {$a->position} en la fecha: {$a->date}';
...
$string['trackusers_help'] = 'Registrar las rutas hechas por los usuarios mientras usan el modo de juego.';
...
$string['userlocationfailed'] = 'Ubicación fallida de la etapa {$a->position} en la fecha: {$a->date}';
$string['userlocationovercome'] = 'Ubicación encontrada de la etapa {$a->position} en la fecha: {$a->date}';
...
$string['validatelocation_tour'] = 'Cuando estés seguro de la ubicación de una etapa del juego debes enviar tu posición para comprobar si has acertado.';
